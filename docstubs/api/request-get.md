---
title: "Get request"
description: "Read properties and relationships of the request object."
author: ""
...
Read properties and relationships of the [request](../resources/request.md) object.
...
-->
``` http
GET /approvalWorkflowProviders/{approvalWorkflowProvidersId}/requests/{requestId}
GET /approvalWorkflowProviders/{approvalWorkflowProvidersId}/requestsAwaitingMyDecision/{requestId}
```
...
## Response
If successful, this method returns a `200 OK` response code and [request](../resources/request.md) object in the response body.
...
-->
``` http
GET https://graph.microsoft.com/beta/approvalWorkflowProviders/{approvalWorkflowProvidersId}/requests/{requestId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.request",
    "id": "a4b913f3-13f3-a4b9-f313-b9a4f313b9a4",
