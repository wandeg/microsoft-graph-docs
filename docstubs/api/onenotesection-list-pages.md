...
-->
``` http
GET https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/sites/{siteId}/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/pages
```
  ...
  "value": [
    {
      ...
      "id": "25f296c6-96c6-25f2-c696-f225c696f225",
      "self": "Self value",
