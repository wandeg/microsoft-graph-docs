...
-->
``` http
GET https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/title/format
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.workbookChartAxisTitleFormat",
    "id": "cc1deeb2-eeb2-cc1d-b2ee-1dccb2ee1dcc"
  }
}
```
