...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/dataLabels/format
...
{
  "@odata.type": "#microsoft.graph.workbookChartDataLabelFormat",
  "id": "a68b0301-0301-a68b-0103-8ba601038ba6"
}
```
