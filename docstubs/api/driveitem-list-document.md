---
title: "List document"
description: "Get the documents from the document navigation property."
...
Get the documents from the document navigation property.
...
GET /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/document
```
