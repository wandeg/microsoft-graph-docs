...
POST /education/classes/{educationClassId}/group/events/{eventId}/snoozeReminder
POST /education/classes/{educationClassId}/group/calendarView/{eventId}/snoozeReminder
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/events/{eventId}/snoozeReminder
