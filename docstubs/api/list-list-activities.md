...
-->
``` http
GET /me/joinedGroups/{groupId}/drive/list/activities
```
...
-->
``` http
GET https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/drive/list/activities
```
  ...
  "value": [
    {
      ...
      "id": "900b6e38-6e38-900b-386e-0b90386e0b90",
      "action": {
      ...
      "times": {
        ...
        "lastRecordedDateTime": "2017-01-01T00:03:30.5412205+00:00",
        "observedDateTime": "2016-12-31T23:57:24.4457075+00:00",
        "recordedDateTime": "2016-12-31T23:59:16.5855988+00:00"
      }
    }
  ]
}
