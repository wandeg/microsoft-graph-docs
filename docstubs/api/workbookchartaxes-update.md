...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes
...
{
  "@odata.type": "#microsoft.graph.workbookChartAxes",
  "id": "d5095975-5975-d509-7559-09d5755909d5"
}
```
