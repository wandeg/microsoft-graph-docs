...
-->
``` http
POST /me/messages/{messageId}/microsoft.graph.eventMessage/event/calendar/calendarPermissions/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/messages/{messageId}/microsoft.graph.eventMessage/event/calendar/calendarPermissions
