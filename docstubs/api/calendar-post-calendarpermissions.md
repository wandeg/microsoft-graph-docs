...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/calendar/calendarPermissions
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/calendar/calendarPermissions
...
{
  "@odata.type": "#microsoft.graph.calendarPermission",
  "id": "5fd44158-4158-5fd4-5841-d45f5841d45f",
  "emailAddress": {
    "@odata.type": "microsoft.graph.emailAddress",
    "name": "Name value",
    "address": "Address value"
