...
-->
``` http
GET /me/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/workbook/functions
```
...
-->
``` http
GET https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/workbook/functions
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.workbookFunctions",
    "id": "4eacb24d-b24d-4eac-4db2-ac4e4db2ac4e"
  }
}
```
