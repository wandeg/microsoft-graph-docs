...
-->
``` http
GET https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/listItem/versions/{listItemVersionId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.listItemVersion",
    "id": "833ff922-f922-833f-22f9-3f8322f93f83",
    "lastModifiedBy": {
