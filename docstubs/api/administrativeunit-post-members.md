...
POST /education/classes/{educationClassId}/members/{educationUserId}/schools/{educationSchoolId}/administrativeUnit/members/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/administrativeUnits/{administrativeUnitsId}/members
