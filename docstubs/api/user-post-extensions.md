...
-->
``` http
POST ** Collection URI for microsoft.graph.extension not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.extension not found
...
{
  "@odata.type": "#microsoft.graph.extension",
  "id": "c8798991-8991-c879-9189-79c8918979c8"
}
```
