...
## Request body
In the request body, supply a JSON representation for the [personAnniversary](../resources/microsoft.fast.pi.viewgenerator.v2.profile.models-personanniversary.md) object.

The following table shows the properties that are required when you create the [personAnniversary](../resources/microsoft.fast.pi.viewgenerator.v2.profile.models-personanniversary.md).
...
## Response
If successful, this method returns a `201 Created` response code and a [personAnniversary](../resources/microsoft.fast.pi.viewgenerator.v2.profile.models-personanniversary.md) object in the response body.
