...
GET /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/primaryChannel
GET /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/channels/{channelId}
```
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.channel",
    "id": "c03f64a9-64a9-c03f-a964-3fc0a9643fc0",
