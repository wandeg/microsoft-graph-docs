...
-->
``` http
POST https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/sites/{siteId}/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/parentSectionGroup/sectionGroups
...
{
  "@odata.type": "#microsoft.graph.sectionGroup",
  "id": "efad7113-7113-efad-1371-adef1371adef",
  "self": "Self value",
