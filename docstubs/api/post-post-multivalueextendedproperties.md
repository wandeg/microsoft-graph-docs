...
-->
``` http
POST /me/joinedGroups/{groupId}/conversations/{conversationId}/threads/{conversationThreadId}/posts/{postId}/multiValueExtendedProperties/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/conversations/{conversationId}/threads/{conversationThreadId}/posts/{postId}/multiValueExtendedProperties
...
{
  "@odata.type": "#microsoft.graph.multiValueLegacyExtendedProperty",
  "id": "7aa9ae17-ae17-7aa9-17ae-a97a17aea97a",
  "value": [
    "Value value"
  ]
}
