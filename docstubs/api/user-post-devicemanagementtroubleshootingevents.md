...
POST /invitations/{invitationsId}/invitedUser/deviceManagementTroubleshootingEvents
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/deviceManagementTroubleshootingEvents
...
{
  "@odata.type": "#microsoft.graph.deviceManagementTroubleshootingEvent",
  "id": "0101b0f6-b0f6-0101-f6b0-0101f6b00101",
  "eventDateTime": "2017-01-01T00:02:43.503642+03:00",
  "correlationId": "Correlation Id value",
  "troubleshootingErrorDetails": {
    "@odata.type": "microsoft.graph.deviceManagementTroubleshootingErrorDetails",
