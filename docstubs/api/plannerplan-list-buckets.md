...
-->
``` http
GET /me/joinedGroups/{groupId}/planner/plans/{plannerPlanId}/buckets
```
...
-->
``` http
GET https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/planner/plans/{plannerPlanId}/buckets
```
  ...
  "value": [
    {
      ...
      "id": "ddb5e596-e596-ddb5-96e5-b5dd96e5b5dd",
      "name": "Name value",
