...
GET /invitations/{invitationsId}/invitedUser/events/{eventId}
GET /invitations/{invitationsId}/invitedUser/calendarView/{eventId}
GET /invitations/{invitationsId}/invitedUser/messages/{messageId}/event
GET /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/events/{eventId}
GET /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/calendarView/{eventId}
GET /invitations/{invitationsId}/invitedUser/messages/{messageId}/event/instances/{eventId}
GET /invitations/{invitationsId}/invitedUser/messages/{messageId}/event/calendar/events/{eventId}
GET /invitations/{invitationsId}/invitedUser/messages/{messageId}/event/calendar/calendarView/{eventId}
```
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.event",
    "id": "1b25aaf7-aaf7-1b25-f7aa-251bf7aa251b",
    ...
    "responseStatus": {
      ...
      "response": "String",
      "time": "2017-01-01T00:01:11.1660239+03:00"
    },
    "uid": "Uid value",
    ...
    "originalStart": "2017-01-01T00:01:53.8499891+03:00",
    "end": {
      "@odata.type": "microsoft.graph.dateTimeTimeZone"
    },
    "location": {
