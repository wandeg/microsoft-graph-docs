...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/format
...
{
  "@odata.type": "#microsoft.graph.workbookChartAreaFormat",
  "id": "75834f2d-4f2d-7583-2d4f-83752d4f8375"
}
```
