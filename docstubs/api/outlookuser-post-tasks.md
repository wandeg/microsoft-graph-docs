...
-->
``` http
POST ** Collection URI for microsoft.graph.outlookTask not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.outlookTask not found
...
{
  "@odata.type": "#microsoft.graph.outlookTask",
  "id": "241056f1-56f1-2410-f156-1024f1561024",
