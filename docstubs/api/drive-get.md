...
Read properties and relationships of a [drive](../resources/drive.md) object.
...
GET /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/drive
```
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.drive",
    "id": "aee0b066-b066-aee0-66b0-e0ae66b0e0ae",
    "createdBy": {
