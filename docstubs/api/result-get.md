---
title: "Get Result"
description: "Read properties and relationships of the Result object."
author: ""
...
Read properties and relationships of the [Result](../resources/result.md) object.
...
## Response
If successful, this method returns a `200 OK` response code and [Result](../resources/result.md) object in the response body.
...
-->
``` http
GET https://graph.microsoft.com/beta/graph/{graphId}
```
