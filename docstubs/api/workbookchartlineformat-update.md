...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/format/line
...
{
  "@odata.type": "#microsoft.graph.workbookChartLineFormat",
  "id": "42e4c2da-c2da-42e4-dac2-e442dac2e442",
  "color": "Color value"
}
```
