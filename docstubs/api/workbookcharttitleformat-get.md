...
-->
``` http
GET https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/title/format
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.workbookChartTitleFormat",
    "id": "f48e6d3a-6d3a-f48e-3a6d-8ef43a6d8ef4"
  }
}
```
