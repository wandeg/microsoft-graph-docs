...
-->
``` http
POST /administrativeUnits/{administrativeUnitsId}/extensions/$ref
POST /education/classes/{educationClassId}/members/{educationUserId}/schools/{educationSchoolId}/administrativeUnit/extensions/$ref
```
...
{
  "@odata.type": "#microsoft.graph.extension",
  "id": "645811e0-11e0-6458-e011-5864e0115864"
}
```
