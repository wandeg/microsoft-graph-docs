---
title: "List Results"
description: "List properties and relationships of the Result objects."
author: ""
...
List properties and relationships of the [Result](../resources/result.md) objects.
...
## Response
If successful, this method returns a `200 OK` response code and a collection of [Result](../resources/result.md) objects in the response body.
...
-->
``` http
GET https://graph.microsoft.com/beta/graph
```
  ...
  "value": [
    {
      ...
      "id": "9bf44c35-4c35-9bf4-354c-f49b354cf49b",
      "entities": {
