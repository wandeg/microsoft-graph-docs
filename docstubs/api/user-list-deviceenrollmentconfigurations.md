...
GET /invitations/{invitationsId}/invitedUser/deviceEnrollmentConfigurations
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/deviceEnrollmentConfigurations
```
