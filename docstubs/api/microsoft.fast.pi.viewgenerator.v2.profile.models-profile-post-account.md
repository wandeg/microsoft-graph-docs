...
## Request body
In the request body, supply a JSON representation for the [userAccountInformation](../resources/microsoft.fast.pi.viewgenerator.v2.profile.models-useraccountinformation.md) object.

The following table shows the properties that are required when you create the [userAccountInformation](../resources/microsoft.fast.pi.viewgenerator.v2.profile.models-useraccountinformation.md).
...
|preferredLanguageTag|[localeInfo](../resources/microsoft.fast.pi.viewgenerator.v2.profile.models-localeinfo.md)|**TODO: Add Description**|
|userPrincipalName|String|**TODO: Add Description**|



## Response
If successful, this method returns a `201 Created` response code and an [userAccountInformation](../resources/microsoft.fast.pi.viewgenerator.v2.profile.models-useraccountinformation.md) object in the response body.
