...
description: "Read properties and relationships of the activityBasedTimeoutPolicy object."
author: ""
...
-->
``` http
GET https://graph.microsoft.com/v1.0/policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicyId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.activityBasedTimeoutPolicy",
    "id": "f4fd08f7-08f7-f4fd-f708-fdf4f708fdf4",
