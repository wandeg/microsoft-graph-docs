...
-->
``` http
GET https://graph.microsoft.com/beta/print/reports/getUserPrintUsageSummary(userId='parameterValue',periodStart=01/01/2017 00:03:03 +03:00,periodEnd=31/12/2016 23:58:37 +03:00)
```
