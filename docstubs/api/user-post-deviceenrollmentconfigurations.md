...
POST /invitations/{invitationsId}/invitedUser/deviceEnrollmentConfigurations
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/deviceEnrollmentConfigurations
