...
description: "Create tokenIssuancePolicies by posting to the tokenIssuancePolicies collection."
author: ""
...
Create tokenIssuancePolicies by posting to the tokenIssuancePolicies collection.
...
-->
``` http
POST https://graph.microsoft.com/beta/servicePrincipals/{servicePrincipalsId}/tokenIssuancePolicies
