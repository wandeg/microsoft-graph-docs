...
GET /education/classes/{educationClassId}/group/acceptedSenders/{directoryObjectId}
GET /education/classes/{educationClassId}/group/rejectedSenders/{directoryObjectId}
```
