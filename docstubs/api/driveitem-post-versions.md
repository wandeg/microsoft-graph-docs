...
POST /me/drive/following/{driveItemId}/versions/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/versions
...
{
  "@odata.type": "#microsoft.graph.driveItemVersion",
  "id": "564f0dcb-0dcb-564f-cb0d-4f56cb0d4f56",
  "lastModifiedBy": {
