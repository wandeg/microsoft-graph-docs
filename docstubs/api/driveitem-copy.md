...
POST /me/drive/following/{driveItemId}/copy
...
POST /me/drive/following/{driveItemId}/listItem/driveItem/copy
POST /me/drive/following/{driveItemId}/children/{driveItemId}/copy
POST /me/followedSites/{siteId}/items/{baseItemId}/microsoft.graph.sharedDriveItem/root/copy
POST /me/followedSites/{siteId}/items/{baseItemId}/microsoft.graph.sharedDriveItem/driveItem/copy
POST /me/followedSites/{siteId}/items/{baseItemId}/microsoft.graph.sharedDriveItem/items/{driveItemId}/copy
POST /me/drive/following/{driveItemId}/analytics/itemActivityStats/{itemActivityStatId}/activities/{itemActivityId}/driveItem/copy
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/drive/root/copy
