...
description: "Create appliesTo by posting to the appliesTo collection."
author: ""
...
-->
``` http
POST /policies/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/policies/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicyId}/appliesTo
