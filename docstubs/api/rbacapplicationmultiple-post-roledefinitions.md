...
-->
``` http
POST /roleManagement/deviceManagement/roleDefinitions/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/roleManagement/deviceManagement/roleDefinitions
...
{
  "@odata.type": "#microsoft.graph.unifiedRoleDefinition",
  "id": "4b64f2bd-f2bd-4b64-bdf2-644bbdf2644b",
  "description": "Description value",
  "displayName": "Display Name value",
  "isBuiltIn": true,
  "isEnabled": true,
