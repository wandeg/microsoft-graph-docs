...
PATCH /me/drive/following/{driveItemId}/permissions/{permissionId}
PATCH /me/followedSites/{siteId}/items/{baseItemId}/microsoft.graph.sharedDriveItem/permission
```
