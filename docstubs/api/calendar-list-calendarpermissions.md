...
-->
``` http
GET /me/messages/{messageId}/microsoft.graph.eventMessage/event/calendar/calendarPermissions
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/me/messages/{messageId}/microsoft.graph.eventMessage/event/calendar/calendarPermissions
```
