...
-->
``` http
POST /deviceManagement/appleUserInitiatedEnrollmentProfiles/{appleUserInitiatedEnrollmentProfileId}/assignments/$ref
```
...
{
  "@odata.type": "#microsoft.graph.appleEnrollmentProfileAssignment",
  "id": "5e5a362d-362d-5e5a-2d36-5a5e2d365a5e",
  "target": {
    "@odata.type": "microsoft.graph.deviceAndAppManagementAssignmentTarget"
  }
}
