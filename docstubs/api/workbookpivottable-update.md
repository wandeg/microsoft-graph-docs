...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/pivotTables/{workbookPivotTableId}
...
{
  "@odata.type": "#microsoft.graph.workbookPivotTable",
  "id": "c218b0c3-b0c3-c218-c3b0-18c2c3b018c2",
  "name": "Name value"
}
```
