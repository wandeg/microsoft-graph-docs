...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/title/format
...
{
  "@odata.type": "#microsoft.graph.workbookChartAxisTitleFormat",
  "id": "798f2521-2521-798f-2125-8f7921258f79"
}
```
