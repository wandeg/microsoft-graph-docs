...
POST /me/drive/following/{driveItemId}/permissions/{permissionId}/grant
POST /me/followedSites/{siteId}/items/{baseItemId}/microsoft.graph.sharedDriveItem/permission/grant
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/shares/{sharesId}/permission/grant
