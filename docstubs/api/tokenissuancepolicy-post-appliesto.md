...
-->
``` http
POST /policies/tokenIssuancePolicies/{tokenIssuancePolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/policies/tokenIssuancePolicies/{tokenIssuancePolicyId}/appliesTo
