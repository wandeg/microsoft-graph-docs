...
-->
``` http
GET https://graph.microsoft.com/beta/print/reports/getPrinterUsageSummary(printerId='parameterValue',periodStart=01/01/2017 00:01:48 +03:00,periodEnd=31/12/2016 23:56:40 +03:00)
```
