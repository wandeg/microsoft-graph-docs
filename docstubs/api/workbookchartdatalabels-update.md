...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/dataLabels
...
{
  "@odata.type": "#microsoft.graph.workbookChartDataLabels",
  "id": "fbac6592-6592-fbac-9265-acfb9265acfb",
  "position": "Position value",
  "separator": "Separator value",
  "showBubbleSize": true,
  "showCategoryName": true,
