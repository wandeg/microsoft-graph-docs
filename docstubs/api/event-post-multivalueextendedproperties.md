...
-->
``` http
POST /me/messages/{messageId}/event/multiValueExtendedProperties/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/me/messages/{messageId}/event/multiValueExtendedProperties
