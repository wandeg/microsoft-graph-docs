...
GET /invitations/{invitationsId}/invitedUser/deviceManagementTroubleshootingEvents
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/deviceManagementTroubleshootingEvents
```
