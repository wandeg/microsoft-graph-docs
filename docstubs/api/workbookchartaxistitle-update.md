...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/title
...
{
  "@odata.type": "#microsoft.graph.workbookChartAxisTitle",
  "id": "f2134f0d-4f0d-f213-0d4f-13f20d4f13f2",
  "text": "Text value",
  "visible": true
}
```
