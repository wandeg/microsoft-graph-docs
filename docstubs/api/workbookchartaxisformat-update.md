...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/format
...
{
  "@odata.type": "#microsoft.graph.workbookChartAxisFormat",
  "id": "acd4302e-302e-acd4-2e30-d4ac2e30d4ac"
}
```
