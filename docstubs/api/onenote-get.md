...
GET /invitations/{invitationsId}/invitedUser/onenote
GET /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/onenote
GET /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/sites/{siteId}/onenote
```
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.onenote",
    "id": "3ff8b178-b178-3ff8-78b1-f83f78b1f83f"
  }
}
```
