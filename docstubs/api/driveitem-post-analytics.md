...
POST /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/analytics/$ref
```
...
{
  "@odata.type": "#microsoft.graph.itemAnalytics",
  "id": "b9df679b-679b-b9df-9b67-dfb99b67dfb9"
}
```
