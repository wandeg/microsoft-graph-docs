...
-->
``` http
GET https://graph.microsoft.com/beta/print/reports/getPrintUsageSummariesByTimeSpan(periodStart=1/1/2017 12:00:52 AM +00:00,periodEnd=12/31/2016 11:58:26 PM +00:00,timeSpanInMinutes=1)
```
