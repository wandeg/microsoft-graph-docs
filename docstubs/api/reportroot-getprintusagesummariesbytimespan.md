...
-->
``` http
GET https://graph.microsoft.com/beta/print/reports/getPrintUsageSummariesByTimeSpan(periodStart=12/31/2016 11:58:23 PM +00:00,periodEnd=1/1/2017 12:02:07 AM +00:00,timeSpanInMinutes=1)
```
