...
-->
``` http
POST /policies/claimsMappingPolicies/{claimsMappingPolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/policies/claimsMappingPolicies/{claimsMappingPolicyId}/appliesTo
