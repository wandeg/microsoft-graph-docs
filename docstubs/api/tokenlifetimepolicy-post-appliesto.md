...
-->
``` http
POST /policies/tokenLifetimePolicies/{tokenLifetimePolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/policies/tokenLifetimePolicies/{tokenLifetimePolicyId}/appliesTo
