...
POST /invitations/{invitationsId}/invitedUser/scopedRoleMemberOf
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/scopedRoleMemberOf
...
{
  "@odata.type": "#microsoft.graph.scopedRoleMembership",
  "id": "2f8d2560-2560-2f8d-6025-8d2f60258d2f",
  "roleId": "Role Id value",
  "administrativeUnitId": "Administrative Unit Id value",
  "roleMemberInfo": {
    "@odata.type": "microsoft.graph.identity",
