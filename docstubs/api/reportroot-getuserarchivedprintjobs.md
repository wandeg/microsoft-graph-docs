...
-->
``` http
GET https://graph.microsoft.com/beta/print/reports/getUserArchivedPrintJobs(userId='parameterValue',periodStart=31/12/2016 23:58:29 +03:00,periodEnd=31/12/2016 23:58:44 +03:00)
```
