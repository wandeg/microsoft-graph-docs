...
-->
``` http
GET https://graph.microsoft.com/beta/print/reports/getUserArchivedPrintJobs(userId='parameterValue',periodStart=01/01/2017 00:01:52 +03:00,periodEnd=01/01/2017 00:01:50 +03:00)
```
