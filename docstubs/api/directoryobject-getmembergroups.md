...
POST /me/joinedGroups/{groupId}/acceptedSenders/{directoryObjectId}/getMemberGroups
POST /me/joinedGroups/{groupId}/rejectedSenders/{directoryObjectId}/getMemberGroups
POST /directory/featureRolloutPolicies/{featureRolloutPolicyId}/appliesTo/{directoryObjectId}/getMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/directoryObjects/{directoryObjectsId}/getMemberGroups
