---
title: "Create favoritePlans"
description: "Create favoritePlans by posting to the favoritePlans collection."
author: ""
...
# Create favoritePlans

Namespace: microsoft.graph

Create favoritePlans by posting to the favoritePlans collection.
...
-->
``` http
POST /me/planner/favoritePlans/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/me/planner/favoritePlans
...
{
  "@odata.type": "#microsoft.graph.plannerPlan",
  "id": "5cc832c7-32c7-5cc8-c732-c85cc732c85c",
  "createdBy": {
    "@odata.type": "microsoft.graph.identitySet",
    "application": {
      "@odata.type": "microsoft.graph.identity",
