...
-->
``` http
GET https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/title
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.workbookChartAxisTitle",
    "id": "475baa79-aa79-475b-79aa-5b4779aa5b47",
    "text": "Text value",
    "visible": true
  }
}
