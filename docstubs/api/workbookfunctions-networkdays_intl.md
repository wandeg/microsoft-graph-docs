...
-->
``` http
POST /me/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/workbook/functions/networkDays_Intl
```
...
-->
``` http
POST https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/workbook/functions/networkDays_Intl
...

{
  "value": {
    "@odata.type": "#microsoft.graph.workbookFunctionResult",
    "id": "39e53d2e-3d2e-39e5-2e3d-e5392e3de539",
    "error": "Error value",
    "value": {
      "@odata.type": "microsoft.graph.Json"
    }
