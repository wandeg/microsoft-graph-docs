---
title: "Add metricValues"
description: "Add metricValues by posting to the metricValues collection."
author: ""
...
-->
``` http
POST /deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaselineId}/deviceBootPerformanceMetrics/metricValues/$ref
```
...
{
  "@odata.type": "#microsoft.graph.userExperienceAnalyticsMetric",
  "id": "8e61c20e-c20e-8e61-0ec2-618e0ec2618e",
  "value": "Double",
  "unit": "Unit value"
}
```
