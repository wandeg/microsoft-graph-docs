...
-->
``` http
POST /me/joinedGroups/{groupId}/sites/{siteId}/onenote/sections/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/sites/{siteId}/onenote/sections
