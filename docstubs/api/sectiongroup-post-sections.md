...
-->
``` http
POST https://graph.microsoft.com/beta/me/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/parentSectionGroup/sections
...
{
  "@odata.type": "#microsoft.graph.onenoteSection",
  "id": "fccbcfab-cfab-fccb-abcf-cbfcabcfcbfc",
  "self": "Self value",
