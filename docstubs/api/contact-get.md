...
GET /invitations/{invitationsId}/invitedUser/contacts/{contactId}
GET /invitations/{invitationsId}/invitedUser/contactFolders/{contactFolderId}/contacts/{contactId}
```
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.contact",
    "id": "fd34f60c-f60c-fd34-0cf6-34fd0cf634fd",
