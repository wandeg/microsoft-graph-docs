...
-->
``` http
POST https://graph.microsoft.com/beta/education/classes/{educationClassId}/members/{educationUserId}/schools/{educationSchoolId}/users
...
{
  "@odata.type": "#microsoft.graph.educationUser",
  "id": "a5ce3fba-3fba-a5ce-ba3f-cea5ba3fcea5",
  "relatedContacts": [
    {
      "@odata.type": "microsoft.graph.relatedContact",
      "id": "Id value",
