...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/tables/{workbookTableId}/sort
...
{
  "@odata.type": "#microsoft.graph.workbookTableSort",
  "id": "90865434-5434-9086-3454-869034548690",
  "fields": [
    {
      "@odata.type": "microsoft.graph.workbookSortField",
      "ascending": true,
