...
POST /me/drive/following/{driveItemId}/preview
...
POST /me/drive/following/{driveItemId}/listItem/driveItem/preview
POST /me/drive/following/{driveItemId}/children/{driveItemId}/preview
POST /me/followedSites/{siteId}/items/{baseItemId}/microsoft.graph.sharedDriveItem/root/preview
POST /me/followedSites/{siteId}/items/{baseItemId}/microsoft.graph.sharedDriveItem/driveItem/preview
POST /me/followedSites/{siteId}/items/{baseItemId}/microsoft.graph.sharedDriveItem/items/{driveItemId}/preview
POST /me/drive/following/{driveItemId}/analytics/itemActivityStats/{itemActivityStatId}/activities/{itemActivityId}/driveItem/preview
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/drive/root/preview
