...
-->
``` http
POST ** Collection URI for microsoft.graph.multiValueLegacyExtendedProperty not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.multiValueLegacyExtendedProperty not found
...
{
  "@odata.type": "#microsoft.graph.multiValueLegacyExtendedProperty",
  "id": "b7746755-6755-b774-5567-74b7556774b7",
  "value": [
    "Value value"
  ]
}
