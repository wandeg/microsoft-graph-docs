...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/messages/{messageId}/microsoft.graph.eventMessage/event/calendar/multiValueExtendedProperties
...
{
  "@odata.type": "#microsoft.graph.multiValueLegacyExtendedProperty",
  "id": "b8fc2dc0-2dc0-b8fc-c02d-fcb8c02dfcb8",
  "value": [
    "Value value"
  ]
}
