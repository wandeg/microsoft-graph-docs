...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/title
...
{
  "@odata.type": "#microsoft.graph.workbookChartTitle",
  "id": "badddf29-df29-badd-29df-ddba29dfddba",
  "overlay": true,
  "text": "Text value",
  "visible": true
}
