...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/drive/items/{driveItemId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/majorGridlines/format
...
{
  "@odata.type": "#microsoft.graph.workbookChartGridlinesFormat",
  "id": "fb61d744-d744-fb61-44d7-61fb44d761fb"
}
```
