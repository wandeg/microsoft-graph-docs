...
-->
``` http
PATCH https://graph.microsoft.com/beta/me/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/majorGridlines/format
...
{
  "@odata.type": "#microsoft.graph.workbookChartGridlinesFormat",
  "id": "b116d0f3-d0f3-b116-f3d0-16b1f3d016b1"
}
```
