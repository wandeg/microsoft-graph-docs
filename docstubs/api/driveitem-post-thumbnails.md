...
POST /me/drive/following/{driveItemId}/thumbnails/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/thumbnails
...
{
  "@odata.type": "#microsoft.graph.thumbnailSet",
  "id": "f6b66509-6509-f6b6-0965-b6f60965b6f6",
  "large": {
    "@odata.type": "microsoft.graph.thumbnail",
    "content": "Stream",
    "height": 6,
