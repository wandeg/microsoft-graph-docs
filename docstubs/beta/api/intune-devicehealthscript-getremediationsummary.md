...
If successful, this method returns a `200 Ok` response code and a [deviceHealthScriptRemediationSummary](../resources/deviceHealthScriptRemediationSummary.md) object in the response body.
