...
| [List managedDevices](../api/intune-detectedapp-list-manageddevices.md)     | managedDevice                                   | Get the managedDevice from a managedDevices navigation property. |
| [Add managedDevices](../api/intune-detectedapp-post-manageddevices.md)      | managedDevice                                   | Add managedDevices by posting to the managedDevices collection.  |
...
| [Update managedDevices](../api/intune-detectedapp-update-manageddevices.md) | managedDevice                                   | Update the properties of a managedDevices object.                |
