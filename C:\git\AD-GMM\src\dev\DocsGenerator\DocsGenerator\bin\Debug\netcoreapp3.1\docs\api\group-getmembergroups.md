...
POST /me/joinedTeams/{groupId}/getMemberGroups
POST /users/{usersId}/joinedTeams/{groupId}/getMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/groups/{groupsId}/getMemberGroups
