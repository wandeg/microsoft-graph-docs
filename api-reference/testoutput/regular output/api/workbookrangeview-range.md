...
-->
``` http
GET ** Entity URI for microsoft.graph.workbookRangeView not found/range
```
...
-->
``` http
GET https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.workbookRangeView not found/range
```
