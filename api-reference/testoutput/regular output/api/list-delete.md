...
-->
``` http
DELETE /me/drive/list
DELETE /drives/{drivesId}/list
DELETE /shares/{sharesId}/list
DELETE /sites/{sitesId}/lists/{listId}
DELETE /me/joinedTeams/{groupId}/sites/{siteId}/lists/{listId}
DELETE /me/joinedTeams/{groupId}/sites/{siteId}/items/{baseItemId}/microsoft.graph.sharedDriveItem/list
```
