...
Update the properties of a [androidStoreApp](../resources/androidstoreapp.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.androidStoreApp not found
