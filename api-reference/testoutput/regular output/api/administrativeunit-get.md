...
-->
``` http
GET ** Entity URI for microsoft.graph.administrativeUnit not found
```
...
-->
``` http
GET https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.administrativeUnit not found
```
