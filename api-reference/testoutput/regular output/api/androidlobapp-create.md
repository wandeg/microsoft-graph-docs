...
## Request body
In the request body, supply a JSON representation for the [androidLobApp](../resources/androidlobapp.md) object.
...
## Response
If successful, this method returns a `201 Created` response code and a [androidLobApp](../resources/androidlobapp.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.androidLobApp not found
Content-type: application/json
Content-length: 1071
...
{
  "@odata.type": "#microsoft.graph.androidLobApp",
  "id": "c4f24109-4109-c4f2-0941-f2c40941f2c4",
  "displayName": "Display Name value",
  "description": "Description value",
  "publisher": "Publisher value",
  "largeIcon": {
