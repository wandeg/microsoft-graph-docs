...
-->
``` http
GET ** Entity URI for microsoft.graph.workbookRange not found/rowsAbove
```
...
-->
``` http
GET https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.workbookRange not found/rowsAbove(count=5)
```
