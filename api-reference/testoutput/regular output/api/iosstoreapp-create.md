...
## Response
If successful, this method returns a `201 Created` response code and a [iosStoreApp](../resources/iosstoreapp.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.iosStoreApp not found
Content-type: application/json
Content-length: 1022
