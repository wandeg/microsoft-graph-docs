...
POST /me/joinedTeams/{groupId}/groupLifecyclePolicies/{groupLifecyclePolicyId}/removeGroup
```
...
-->
``` http
POST https://graph.microsoft.com/docs\api/groupLifecyclePolicies/{groupLifecyclePoliciesId}/removeGroup
