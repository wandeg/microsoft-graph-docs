...
-->
``` http
GET ** Entity URI for microsoft.graph.workbookRange not found/columnsBefore
```
...
-->
``` http
GET https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.workbookRange not found/columnsBefore(count=5)
```
