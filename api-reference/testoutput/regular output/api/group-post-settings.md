...
## Request body
In the request body, supply a JSON representation for the groupSetting object.

The following table shows the properties that are required when you create the groupSetting.
