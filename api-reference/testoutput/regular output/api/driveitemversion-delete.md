...
DELETE /me/drive/items/{driveItemId}/versions/{driveItemVersionId}
```
...
-->
``` http
DELETE https://graph.microsoft.com/localtest/workbooks/{workbooksId}/versions/{driveItemVersionId}
```
