...
Deletes a [deviceInstallState](../resources/deviceinstallstate.md).
...
-->
``` http
DELETE https://graph.microsoft.com/localtest/deviceAppManagement/managedEBooks/{managedEBookId}/deviceStates/{deviceInstallStateId}
```
