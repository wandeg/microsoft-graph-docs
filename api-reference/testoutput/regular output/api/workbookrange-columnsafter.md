...
-->
``` http
GET ** Entity URI for microsoft.graph.workbookRange not found/columnsAfter
```
...
-->
``` http
GET https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.workbookRange not found/columnsAfter(count=5)
```
