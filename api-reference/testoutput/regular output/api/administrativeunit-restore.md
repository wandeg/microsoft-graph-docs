...
-->
``` http
POST ** Entity URI for microsoft.graph.administrativeUnit not found/restore
```
...
-->
``` http
POST https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.administrativeUnit not found/restore
```
