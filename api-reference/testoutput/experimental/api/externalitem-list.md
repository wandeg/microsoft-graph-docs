...
description: "List properties and relationships of the externalItem objects."
author: ""
...
List properties and relationships of the [externalItem](../resources/externalitem.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/connections/{connectionsId}/items
```
