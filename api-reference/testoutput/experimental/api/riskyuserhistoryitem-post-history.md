...
-->
``` http
POST /riskyUsers/{riskyUsersId}/history/{riskyUserHistoryItemId}/history/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/riskyUsers/{riskyUsersId}/history/{riskyUserHistoryItemId}/history
Content-type: application/json
Content-length: 595
