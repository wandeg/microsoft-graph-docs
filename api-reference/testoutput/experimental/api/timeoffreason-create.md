...
-->
``` http
POST /me/joinedGroups/{groupId}/team/schedule/timeOffReasons
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/joinedGroups/{groupId}/team/schedule/timeOffReasons
Content-type: application/json
Content-length: 141
