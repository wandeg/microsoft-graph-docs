...
POST /me/joinedGroups/{groupId}/drive/activities
POST /me/joinedGroups/{groupId}/drive/list/activities
POST /me/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/activities
POST /me/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/listItem/activities
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/drives/{drivesId}/activities
Content-type: application/json
Content-length: 2271
