...
## Request body
In the request body, supply a JSON representation for the workPosition object.

The following table shows the properties that are required when you create the workPosition.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/me/profile/positions
Content-type: application/json
Content-length: 1553
