...
description: "List properties and relationships of the customerPayment objects."
author: ""
...
List properties and relationships of the [customerPayment](../resources/customerpayment.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/financials/companies/{companyId}/customerPayments
```
