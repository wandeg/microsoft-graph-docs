...
Update the properties of a [androidWorkProfilePkcsCertificateProfile](../resources/androidworkprofilepkcscertificateprofile.md) object.
...
## Request body
In the request body, supply a JSON representation for the [androidWorkProfilePkcsCertificateProfile](../resources/androidWorkProfilePkcsCertificateProfile.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/docs\api** Entity URI for microsoft.graph.androidWorkProfilePkcsCertificateProfile not found
