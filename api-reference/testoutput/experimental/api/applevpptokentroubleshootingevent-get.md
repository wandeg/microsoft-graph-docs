...
-->
``` http
GET ** Entity URI for microsoft.graph.appleVppTokenTroubleshootingEvent not found
```
...
## Response
If successful, this method returns a `200 OK` response code and [appleVppTokenTroubleshootingEvent](../resources/applevpptokentroubleshootingevent.md) object in the response body.
