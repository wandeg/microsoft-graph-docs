...
Deletes a [userExperienceAnalyticsOverview](../resources/userexperienceanalyticsoverview.md).
...
-->
``` http
DELETE https://graph.microsoft.com/docs\api/deviceManagement/userExperienceAnalyticsOverview
```
