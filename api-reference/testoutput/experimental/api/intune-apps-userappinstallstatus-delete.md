...
Deletes a [userAppInstallStatus](../resources/userappinstallstatus.md).
...
-->
``` http
DELETE https://graph.microsoft.com/docs\api/deviceAppManagement/mobileApps/{mobileAppId}/userStatuses/{userAppInstallStatusId}
```
