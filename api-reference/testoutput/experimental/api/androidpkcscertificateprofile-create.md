...
## Request body
In the request body, supply a JSON representation for the [androidPkcsCertificateProfile](../resources/androidpkcscertificateprofile.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.androidPkcsCertificateProfile not found
Content-type: application/json
Content-length: 1541
