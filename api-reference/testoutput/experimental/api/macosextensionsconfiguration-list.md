...
List properties and relationships of the [macOSExtensionsConfiguration](../resources/macosextensionsconfiguration.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.macOSExtensionsConfiguration not found
```
