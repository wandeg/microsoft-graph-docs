...
-->
``` http
POST /me/joinedGroups/{groupId}/team/channels/{channelId}/tabs
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/joinedGroups/{groupId}/team/channels/{channelId}/tabs
Content-type: application/json
Content-length: 565
