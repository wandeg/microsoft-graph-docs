...
description: "List properties and relationships of the onenotePage objects."
author: ""
...
List properties and relationships of the [onenotePage](../resources/onenotepage.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/me/joinedGroups/{groupId}/sites/{siteId}/onenote/pages
```
