...
-->
``` http
GET https://graph.microsoft.com/docs\api** Collection URI for microsoft.graph.windows10CertificateProfileBase not found
```
  ...
  "value": [
    {
      ...
      "id": "297731b2-31b2-2977-b231-7729b2317729",
