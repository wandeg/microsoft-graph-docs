...
-->
``` http
GET https://graph.microsoft.com/localtest/reports/getSkypeForBusinessDeviceUsageDistributionUserCounts(period='parameterValue')
```
  ...
  "value": [
    {
      ...
      "id": "def733b5-33b5-def7-b533-f7deb533f7de",
