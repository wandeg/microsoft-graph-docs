...
-->
``` http
GET https://graph.microsoft.com/localtest/reports/getSkypeForBusinessParticipantActivityUserCounts(period='parameterValue')
```
  ...
  "value": [
    {
      ...
      "id": "5ce1b971-b971-5ce1-71b9-e15c71b9e15c",
      "im": 2,
      "audioVideo": 10,
      "appSharing": 10,
      "web": 3,
