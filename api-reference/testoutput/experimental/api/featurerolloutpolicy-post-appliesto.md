...
-->
``` http
POST /directory/featureRolloutPolicies/{featureRolloutPolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/directory/featureRolloutPolicies/{featureRolloutPolicyId}/appliesTo
Content-type: application/json
Content-length: 116
