...
description: "List properties and relationships of the shipmentMethod objects."
author: ""
...
List properties and relationships of the [shipmentMethod](../resources/shipmentmethod.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/financials/companies/{companyId}/shipmentMethods
```
