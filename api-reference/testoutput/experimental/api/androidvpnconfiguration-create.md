...
## Request body
In the request body, supply a JSON representation for the [androidVpnConfiguration](../resources/androidvpnconfiguration.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.androidVpnConfiguration not found
Content-type: application/json
Content-length: 1493
...
{
  "@odata.type": "#microsoft.graph.androidVpnConfiguration",
  "id": "8a2c6286-6286-8a2c-8662-2c8a86622c8a",
