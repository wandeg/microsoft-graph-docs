...
description: "List properties and relationships of the businessFlow objects."
author: ""
...
List properties and relationships of the [businessFlow](../resources/businessflow.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/approvalWorkflowProviders/{approvalWorkflowProvidersId}/businessFlows
```
