...
## Request body
In the request body, supply a JSON representation for the [androidWiFiConfiguration](../resources/androidwificonfiguration.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.androidWiFiConfiguration not found
Content-type: application/json
Content-length: 1064
...
{
  "@odata.type": "#microsoft.graph.androidWiFiConfiguration",
  "id": "1abee029-e029-1abe-29e0-be1a29e0be1a",
