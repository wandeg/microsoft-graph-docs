...
## Request body
In the request body, supply a JSON representation for the calendarSharingMessage object.

The following table shows the properties that are required when you create the calendarSharingMessage.
...
-->
``` http
POST https://graph.microsoft.com/docs\api** Collection URI for microsoft.graph.calendarSharingMessage not found
Content-type: application/json
Content-length: 2794
