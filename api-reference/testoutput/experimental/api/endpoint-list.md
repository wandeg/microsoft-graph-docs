...
description: "List properties and relationships of the endpoint objects."
author: ""
...
List properties and relationships of the [endpoint](../resources/endpoint.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/groups/{groupsId}/endpoints
```
