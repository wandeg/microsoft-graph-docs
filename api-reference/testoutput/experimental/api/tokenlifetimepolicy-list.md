...
description: "List properties and relationships of the tokenLifetimePolicy objects."
author: ""
...
List properties and relationships of the [tokenLifetimePolicy](../resources/tokenlifetimepolicy.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/policies/tokenLifetimePolicies
```
