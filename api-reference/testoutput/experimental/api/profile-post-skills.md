...
## Request body
In the request body, supply a JSON representation for the skillProficiency object.

The following table shows the properties that are required when you create the skillProficiency.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/me/profile/skills
Content-type: application/json
Content-length: 768
...
{
  "@odata.type": "#microsoft.graph.skillProficiency",
  "id": "61006248-6248-6100-4862-006148620061",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "microsoft.graph.inferenceData",
    "confidenceScore": "Double",
