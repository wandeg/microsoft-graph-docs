...
## Request body
In the request body, supply a JSON representation for the [windowsIdentityProtectionConfiguration](../resources/windowsIdentityProtectionConfiguration.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/docs\api** Entity URI for microsoft.graph.windowsIdentityProtectionConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.windowsIdentityProtectionConfiguration",
  "id": "41d81b00-1b00-41d8-001b-d841001bd841",
