...
## Request body
In the request body, supply a JSON representation for the [managedIOSStoreApp](../resources/managediosstoreapp.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.managedIOSStoreApp not found
Content-type: application/json
Content-length: 1226
...
{
  "@odata.type": "#microsoft.graph.managedIOSStoreApp",
  "id": "c9b48bc5-8bc5-c9b4-c58b-b4c9c58bb4c9",
  "displayName": "Display Name value",
  "description": "Description value",
  "publisher": "Publisher value",
  "largeIcon": {
