...
## Request body
In the request body, supply a JSON representation for the [windowsPhone81ImportedPFXCertificateProfile](../resources/windowsphone81importedpfxcertificateprofile.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.windowsPhone81ImportedPFXCertificateProfile not found
Content-type: application/json
Content-length: 1178
