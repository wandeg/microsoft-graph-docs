...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.iosScepCertificateProfile not found
Content-type: application/json
Content-length: 1701
...
{
  "@odata.type": "#microsoft.graph.iosScepCertificateProfile",
  "id": "88898a48-8a48-8889-488a-8988488a8988",
