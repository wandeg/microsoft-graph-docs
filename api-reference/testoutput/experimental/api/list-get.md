...
GET /me/joinedGroups/{groupId}/drive/list
GET /me/joinedGroups/{groupId}/sites/{siteId}/lists/{listId}
GET /me/joinedGroups/{groupId}/sites/{siteId}/items/{baseItemId}/microsoft.graph.sharedDriveItem/list
```
...
-->
``` http
GET https://graph.microsoft.com/localtest/drives/{drivesId}/list
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.list",
    "id": "7ac00df6-0df6-7ac0-f60d-c07af60dc07a",
    "createdBy": {
