...
Update the properties of a [iosikEv2VpnConfiguration](../resources/iosikev2vpnconfiguration.md) object.
...
## Request body
In the request body, supply a JSON representation for the [iosikEv2VpnConfiguration](../resources/iosikEv2VpnConfiguration.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/docs\api** Entity URI for microsoft.graph.iosikEv2VpnConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.iosikEv2VpnConfiguration",
  "id": "64be8299-8299-64be-9982-be649982be64",
