...
description: "List properties and relationships of the eventMessageResponse objects."
author: ""
...
List properties and relationships of the [eventMessageResponse](../resources/eventmessageresponse.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/docs\api** Collection URI for microsoft.graph.eventMessageResponse not found
```
