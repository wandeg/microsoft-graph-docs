...
description: "List properties and relationships of the agedAccountsPayable objects."
author: ""
...
List properties and relationships of the [agedAccountsPayable](../resources/agedaccountspayable.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/financials/companies/{companyId}/agedAccountsPayable
```
