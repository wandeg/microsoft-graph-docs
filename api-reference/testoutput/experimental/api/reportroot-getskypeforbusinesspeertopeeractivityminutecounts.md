...
-->
``` http
GET https://graph.microsoft.com/localtest/reports/getSkypeForBusinessPeerToPeerActivityMinuteCounts(period='parameterValue')
```
  ...
  "value": [
    {
      ...
      "id": "0c5bc592-c592-0c5b-92c5-5b0c92c55b0c",
      "audio": 5,
      "video": 5,
