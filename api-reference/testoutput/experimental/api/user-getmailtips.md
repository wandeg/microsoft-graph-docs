...
-->
``` http
POST /me/managedDevices/{managedDeviceId}/users/{userId}/getMailTips
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/me/managedDevices/{managedDeviceId}/users/{userId}/getMailTips
