...
Deletes a [roleAssignment](../resources/roleassignment.md).
...
-->
``` http
DELETE https://graph.microsoft.com/localtest/deviceManagement/roleDefinitions/{roleDefinitionId}/roleAssignments/{roleAssignmentId}
```
