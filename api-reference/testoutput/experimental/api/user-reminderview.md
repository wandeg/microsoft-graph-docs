...
-->
``` http
GET https://graph.microsoft.com/localtest/me/managedDevices/{managedDeviceId}/users/{userId}/reminderView(StartDateTime='parameterValue',EndDateTime='parameterValue')
```
