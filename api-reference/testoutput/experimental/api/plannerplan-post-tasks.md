...
-->
``` http
POST /me/joinedGroups/{groupId}/planner/plans/{plannerPlanId}/tasks/$ref
```
...
## Request body
In the request body, supply a JSON representation for the plannerTask object.

The following table shows the properties that are required when you create the plannerTask.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/me/joinedGroups/{groupId}/planner/plans/{plannerPlanId}/tasks
Content-type: application/json
Content-length: 1270
