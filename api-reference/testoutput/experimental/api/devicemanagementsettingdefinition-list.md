...
List properties and relationships of the [deviceManagementSettingDefinition](../resources/devicemanagementsettingdefinition.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/deviceManagement/settingDefinitions
```
