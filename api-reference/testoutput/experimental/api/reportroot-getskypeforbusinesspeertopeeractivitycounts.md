...
-->
``` http
GET https://graph.microsoft.com/localtest/reports/getSkypeForBusinessPeerToPeerActivityCounts(period='parameterValue')
```
  ...
  "value": [
    {
      ...
      "id": "de4438b0-38b0-de44-b038-44deb03844de",
      "im": 2,
      "audio": 5,
      "video": 5,
      "appSharing": 10,
