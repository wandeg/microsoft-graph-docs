...
description: "List properties and relationships of the activityBasedTimeoutPolicy objects."
author: ""
...
List properties and relationships of the [activityBasedTimeoutPolicy](../resources/activitybasedtimeoutpolicy.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/policies/activityBasedTimeoutPolicies
```
