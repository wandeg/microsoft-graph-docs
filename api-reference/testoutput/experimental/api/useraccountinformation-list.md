...
description: "List properties and relationships of the userAccountInformation objects."
author: ""
...
List properties and relationships of the [userAccountInformation](../resources/useraccountinformation.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/me/profile/account
```
