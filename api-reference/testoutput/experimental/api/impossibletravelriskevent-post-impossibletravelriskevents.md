...
## Request body
In the request body, supply a JSON representation for the impossibleTravelRiskEvent object.

The following table shows the properties that are required when you create the impossibleTravelRiskEvent.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/impossibleTravelRiskEvents
Content-type: application/json
Content-length: 1138
