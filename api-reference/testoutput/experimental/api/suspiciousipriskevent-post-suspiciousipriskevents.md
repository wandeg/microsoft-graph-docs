...
## Request body
In the request body, supply a JSON representation for the suspiciousIpRiskEvent object.

The following table shows the properties that are required when you create the suspiciousIpRiskEvent.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/suspiciousIpRiskEvents
Content-type: application/json
Content-length: 812
