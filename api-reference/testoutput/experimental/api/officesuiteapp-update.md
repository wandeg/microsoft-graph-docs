...
Update the properties of a [officeSuiteApp](../resources/officesuiteapp.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.officeSuiteApp not found
