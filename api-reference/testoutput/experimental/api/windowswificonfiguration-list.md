...
List properties and relationships of the [windowsWifiConfiguration](../resources/windowswificonfiguration.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/docs\api** Collection URI for microsoft.graph.windowsWifiConfiguration not found
```
