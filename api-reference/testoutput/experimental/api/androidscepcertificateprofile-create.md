...
## Request body
In the request body, supply a JSON representation for the [androidScepCertificateProfile](../resources/androidscepcertificateprofile.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.androidScepCertificateProfile not found
Content-type: application/json
Content-length: 1547
...
{
  "@odata.type": "#microsoft.graph.androidScepCertificateProfile",
  "id": "5556b9e1-b9e1-5556-e1b9-5655e1b95655",
