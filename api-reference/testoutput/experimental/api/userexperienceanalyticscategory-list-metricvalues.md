...
description: "Get the userExperienceAnalyticsMetrics from the metricValues navigation property."
author: ""
...
Get the userExperienceAnalyticsMetrics from the metricValues navigation property.
...
-->
``` http
GET https://graph.microsoft.com/localtest/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaselineId}/deviceBootPerformanceMetrics/metricValues
```
  ...
  "value": [
    {
      ...
      "id": "460bc2a6-c2a6-460b-a6c2-0b46a6c20b46",
      "value": "Double",
      "unit": "Unit value"
    }
  ]
