...
GET /education/classes/{educationClassId}/members/{educationUserId}/schools/{educationSchoolId}/administrativeUnit/members
```
...
-->
``` http
GET https://graph.microsoft.com/localtest/administrativeUnits/{administrativeUnitsId}/members
```
