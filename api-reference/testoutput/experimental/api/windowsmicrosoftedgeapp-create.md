...
## Request body
In the request body, supply a JSON representation for the [windowsMicrosoftEdgeApp](../resources/windowsmicrosoftedgeapp.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.windowsMicrosoftEdgeApp not found
Content-type: application/json
Content-length: 742
