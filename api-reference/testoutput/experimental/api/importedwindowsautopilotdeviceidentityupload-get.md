...
-->
``` http
GET ** Entity URI for microsoft.graph.importedWindowsAutopilotDeviceIdentityUpload not found
```
...
## Response
If successful, this method returns a `200 OK` response code and [importedWindowsAutopilotDeviceIdentityUpload](../resources/importedwindowsautopilotdeviceidentityupload.md) object in the response body.
