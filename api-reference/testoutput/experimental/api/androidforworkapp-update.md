...
Update the properties of a [androidForWorkApp](../resources/androidforworkapp.md) object.
...
## Request body
In the request body, supply a JSON representation for the [androidForWorkApp](../resources/androidforworkapp.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.androidForWorkApp not found
