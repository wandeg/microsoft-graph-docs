...
-->
``` http
GET /applications/{applicationsId}/activityBasedTimeoutPolicies
```
...
-->
``` http
GET https://graph.microsoft.com/localtest/applications/{applicationsId}/activityBasedTimeoutPolicies
```
