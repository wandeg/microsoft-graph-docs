...
description: "List properties and relationships of the riskyUserHistoryItem objects."
author: ""
...
List properties and relationships of the [riskyUserHistoryItem](../resources/riskyuserhistoryitem.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/riskyUsers/{riskyUsersId}/history
```
