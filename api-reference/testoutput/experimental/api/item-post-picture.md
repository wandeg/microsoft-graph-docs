...
-->
``` http
POST /financials/companies/{companyId}/items/{itemId}/picture/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/financials/companies/{companyId}/items/{itemId}/picture
Content-type: application/json
Content-length: 144
