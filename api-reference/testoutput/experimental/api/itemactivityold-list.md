...
description: "List properties and relationships of the itemActivityOLD objects."
author: ""
...
List properties and relationships of the [itemActivityOLD](../resources/itemactivityold.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/drives/{drivesId}/activities
```
