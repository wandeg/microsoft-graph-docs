...
-->
``` http
GET https://graph.microsoft.com/docs\api** Collection URI for microsoft.graph.macOSDeviceFeaturesConfiguration not found
```
  ...
  "value": [
    {
      ...
      "id": "651f1164-1164-651f-6411-1f6564111f65",
