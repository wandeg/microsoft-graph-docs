...
Deletes a [dataSharingConsent](../resources/datasharingconsent.md).
...
-->
``` http
DELETE https://graph.microsoft.com/docs\api/deviceManagement/dataSharingConsents/{dataSharingConsentId}
```
