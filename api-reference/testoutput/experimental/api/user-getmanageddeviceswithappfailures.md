---
title: "getManagedDevicesWithAppFailures"
description: ""
author: ""
...
-->
``` http
GET https://graph.microsoft.com/localtest/me/managedDevices/{managedDeviceId}/users/{userId}/getManagedDevicesWithAppFailures
```
