...
description: "List properties and relationships of the chatMessage objects."
author: ""
...
List properties and relationships of the [chatMessage](../resources/chatmessage.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/chats/{chatsId}/messages
```
