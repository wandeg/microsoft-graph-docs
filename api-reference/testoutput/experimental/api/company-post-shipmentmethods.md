...
## Request body
In the request body, supply a JSON representation for the shipmentMethod object.

The following table shows the properties that are required when you create the shipmentMethod.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/financials/companies/{companyId}/shipmentMethods
Content-type: application/json
Content-length: 121
