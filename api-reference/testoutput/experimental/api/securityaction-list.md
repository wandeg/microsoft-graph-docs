...
description: "List properties and relationships of the securityAction objects."
author: ""
...
List properties and relationships of the [securityAction](../resources/securityaction.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/Security/securityActions
```
