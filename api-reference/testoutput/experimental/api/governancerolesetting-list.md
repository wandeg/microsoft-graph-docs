...
description: "List properties and relationships of the governanceRoleSetting objects."
author: ""
...
List properties and relationships of the [governanceRoleSetting](../resources/governancerolesetting.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/governanceRoleSettings
```
