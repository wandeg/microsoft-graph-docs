...
Update the properties of a [iosEduDeviceConfiguration](../resources/iosedudeviceconfiguration.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.iosEduDeviceConfiguration not found
