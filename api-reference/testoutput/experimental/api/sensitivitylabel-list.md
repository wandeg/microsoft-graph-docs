...
description: "List properties and relationships of the sensitivityLabel objects."
author: ""
...
List properties and relationships of the [sensitivityLabel](../resources/sensitivitylabel.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/dataClassification/sensitivityLabels
```
