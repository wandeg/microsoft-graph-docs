...
description: "List properties and relationships of the dimensionValue objects."
author: ""
...
List properties and relationships of the [dimensionValue](../resources/dimensionvalue.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/financials/companies/{companyId}/dimensionValues
```
