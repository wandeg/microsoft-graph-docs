...
POST /me/devices/{deviceId}/checkMemberGroups
POST /users/{usersId}/devices/{deviceId}/checkMemberGroups
```
...
-->
``` http
POST https://graph.microsoft.com/docs\api/devices/{devicesId}/checkMemberGroups
