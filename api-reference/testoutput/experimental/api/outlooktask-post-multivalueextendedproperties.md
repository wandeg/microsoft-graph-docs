...
-->
``` http
POST https://graph.microsoft.com/docs\api/me/outlook/taskGroups/{outlookTaskGroupId}/taskFolders/{outlookTaskFolderId}/tasks/{outlookTaskId}/multiValueExtendedProperties
Content-type: application/json
Content-length: 113
