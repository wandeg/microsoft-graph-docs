...
-->
``` http
GET ** Entity URI for microsoft.graph.depEnrollmentProfile not found
```
...
## Response
If successful, this method returns a `200 OK` response code and [depEnrollmentProfile](../resources/depenrollmentprofile.md) object in the response body.
