...
-->
``` http
GET https://graph.microsoft.com/docs\api** Collection URI for microsoft.graph.targetedManagedAppProtection not found
```
  ...
  "value": [
    {
      ...
      "id": "228db675-b675-228d-75b6-8d2275b68d22",
