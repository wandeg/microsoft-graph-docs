...
description: "Update the properties of a eventMessageResponse object."
author: ""
...
Update the properties of a [eventMessageResponse](../resources/eventmessageresponse.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/docs\api** Entity URI for microsoft.graph.eventMessageResponse not found
