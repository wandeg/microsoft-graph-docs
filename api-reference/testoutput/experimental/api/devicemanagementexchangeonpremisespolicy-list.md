...
description: "List properties and relationships of the deviceManagementExchangeOnPremisesPolicy objects."
author: ""
...
List properties and relationships of the [deviceManagementExchangeOnPremisesPolicy](../resources/devicemanagementexchangeonpremisespolicy.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/deviceManagement/exchangeOnPremisesPolicies
```
