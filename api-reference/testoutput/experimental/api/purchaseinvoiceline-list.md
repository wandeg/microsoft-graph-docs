...
description: "List properties and relationships of the purchaseInvoiceLine objects."
author: ""
...
List properties and relationships of the [purchaseInvoiceLine](../resources/purchaseinvoiceline.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/financials/companies/{companyId}/purchaseInvoiceLines
```
