...
-->
``` http
GET https://graph.microsoft.com/localtest/reports/getYammerDeviceUsageDistributionUserCounts(period='parameterValue')
```
  ...
  "value": [
    {
      ...
      "id": "24afcb4a-cb4a-24af-4acb-af244acbaf24",
