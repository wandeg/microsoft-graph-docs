---
title: "Create networkAccessConfigurations"
description: "Create networkAccessConfigurations by posting to the networkAccessConfigurations collection."
author: ""
...
# Create networkAccessConfigurations

Namespace: microsoft.graph

Create networkAccessConfigurations by posting to the networkAccessConfigurations collection.
...
-->
``` http
POST /deviceManagement/deviceConfigurations/{deviceConfigurationId}/microsoft.graph.windowsDomainJoinConfiguration/networkAccessConfigurations/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/deviceManagement/deviceConfigurations/{deviceConfigurationId}/microsoft.graph.windowsDomainJoinConfiguration/networkAccessConfigurations
Content-type: application/json
Content-length: 885
