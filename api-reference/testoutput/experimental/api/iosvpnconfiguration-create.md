...
## Request body
In the request body, supply a JSON representation for the [iosVpnConfiguration](../resources/iosvpnconfiguration.md) object.
...
|providerType|Enumeration|Provider type for per-app VPN. Possible values are: `notConfigured`, `appProxy`, `packetTunnel`.|
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.iosVpnConfiguration not found
Content-type: application/json
Content-length: 2506
...
{
  "@odata.type": "#microsoft.graph.iosVpnConfiguration",
  "id": "64b0a8f2-a8f2-64b0-f2a8-b064f2a8b064",
