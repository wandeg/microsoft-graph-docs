...
description: "List properties and relationships of the itemCategory objects."
author: ""
...
List properties and relationships of the [itemCategory](../resources/itemcategory.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/financials/companies/{companyId}/itemCategories
```
