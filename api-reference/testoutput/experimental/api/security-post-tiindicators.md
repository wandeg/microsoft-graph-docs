...
## Request body
In the request body, supply a JSON representation for the tiIndicator object.

The following table shows the properties that are required when you create the tiIndicator.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/Security/tiIndicators
Content-type: application/json
Content-length: 2539
