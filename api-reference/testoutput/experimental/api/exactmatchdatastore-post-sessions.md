...
## Request body
In the request body, supply a JSON representation for the exactMatchSession object.

The following table shows the properties that are required when you create the exactMatchSession.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/dataClassification/exactMatchDataStores/{exactMatchDataStoreId}/sessions
Content-type: application/json
Content-length: 1360
