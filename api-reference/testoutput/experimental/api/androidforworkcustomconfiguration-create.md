...
## Request body
In the request body, supply a JSON representation for the [androidForWorkCustomConfiguration](../resources/androidforworkcustomconfiguration.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.androidForWorkCustomConfiguration not found
Content-type: application/json
Content-length: 1077
