...
## Request body
In the request body, supply a JSON representation for the [iosWiFiConfiguration](../resources/ioswificonfiguration.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.iosWiFiConfiguration not found
Content-type: application/json
Content-length: 1306
...
{
  "@odata.type": "#microsoft.graph.iosWiFiConfiguration",
  "id": "e19852b9-52b9-e198-b952-98e1b95298e1",
