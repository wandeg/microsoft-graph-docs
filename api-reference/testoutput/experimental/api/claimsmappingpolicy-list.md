...
description: "List properties and relationships of the claimsMappingPolicy objects."
author: ""
...
List properties and relationships of the [claimsMappingPolicy](../resources/claimsmappingpolicy.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/policies/claimsMappingPolicies
```
