---
title: "Add assignedLicenses"
description: "Add assignedLicenses by posting to the assignedLicenses collection."
author: ""
...
-->
``` http
POST /deviceAppManagement/mobileApps/{mobileAppId}/microsoft.graph.macOsVppApp/assignedLicenses/$ref
```
