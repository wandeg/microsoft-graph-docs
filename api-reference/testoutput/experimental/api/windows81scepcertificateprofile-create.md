...
## Request body
In the request body, supply a JSON representation for the [windows81SCEPCertificateProfile](../resources/windows81scepcertificateprofile.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.windows81SCEPCertificateProfile not found
Content-type: application/json
Content-length: 1772
...
{
  "@odata.type": "#microsoft.graph.windows81SCEPCertificateProfile",
  "id": "a0b7c871-c871-a0b7-71c8-b7a071c8b7a0",
