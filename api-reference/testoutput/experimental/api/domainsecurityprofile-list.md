...
description: "List properties and relationships of the domainSecurityProfile objects."
author: ""
...
List properties and relationships of the [domainSecurityProfile](../resources/domainsecurityprofile.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/Security/domainSecurityProfiles
```
