---
title: "Add userRunStates"
description: "Add userRunStates by posting to the userRunStates collection."
author: ""
...
-->
``` http
POST /deviceManagement/deviceShellScripts/{deviceShellScriptId}/userRunStates/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/deviceManagement/deviceShellScripts/{deviceShellScriptId}/userRunStates
...
{
  "@odata.type": "#microsoft.graph.deviceManagementScriptUserState",
  "id": "7449093d-093d-7449-3d09-49743d094974",
  "successDeviceCount": 2,
  "errorDeviceCount": 0,
  "userPrincipalName": "User Principal Name value"
}
