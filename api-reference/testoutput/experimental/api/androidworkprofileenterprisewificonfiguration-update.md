...
Update the properties of a [androidWorkProfileEnterpriseWiFiConfiguration](../resources/androidworkprofileenterprisewificonfiguration.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/docs\api** Entity URI for microsoft.graph.androidWorkProfileEnterpriseWiFiConfiguration not found
...
{
  "@odata.type": "#microsoft.graph.androidWorkProfileEnterpriseWiFiConfiguration",
  "id": "ee15a746-a746-ee15-46a7-15ee46a715ee",
