...
## Request body
In the request body, supply a JSON representation for the [windows10CustomConfiguration](../resources/windows10customconfiguration.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.windows10CustomConfiguration not found
Content-type: application/json
Content-length: 1072
...
{
  "@odata.type": "#microsoft.graph.windows10CustomConfiguration",
  "id": "328187d8-87d8-3281-d887-8132d8878132",
