...
## Request body
In the request body, supply a JSON representation for the [macOsVppApp](../resources/macosvppapp.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.macOsVppApp not found
