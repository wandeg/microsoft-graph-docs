...
## Request body
In the request body, supply a JSON representation for the customer object.

The following table shows the properties that are required when you create the customer.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/financials/companies/{companyId}/customers
Content-type: application/json
Content-length: 1013
