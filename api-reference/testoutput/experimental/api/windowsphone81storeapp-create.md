...
## Request body
In the request body, supply a JSON representation for the [windowsPhone81StoreApp](../resources/windowsphone81storeapp.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.windowsPhone81StoreApp not found
Content-type: application/json
Content-length: 771
