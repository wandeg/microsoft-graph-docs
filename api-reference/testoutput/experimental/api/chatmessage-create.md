...
POST /me/joinedGroups/{groupId}/team/channels/{channelId}/messages
POST /me/joinedGroups/{groupId}/team/channels/{channelId}/messages/{chatMessageId}/replies
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/chats/{chatsId}/messages
Content-type: application/json
Content-length: 2162
