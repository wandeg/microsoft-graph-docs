...
## Request body
In the request body, supply a JSON representation for the [macOSLobApp](../resources/macoslobapp.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.macOSLobApp not found
Content-type: application/json
Content-length: 1482
