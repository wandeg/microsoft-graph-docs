...
List properties and relationships of the [iosikEv2VpnConfiguration](../resources/iosikev2vpnconfiguration.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/docs\api** Collection URI for microsoft.graph.iosikEv2VpnConfiguration not found
```
