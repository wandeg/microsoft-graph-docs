...
## Request body
In the request body, supply a JSON representation for the [macOSWiFiConfiguration](../resources/macoswificonfiguration.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.macOSWiFiConfiguration not found
Content-type: application/json
Content-length: 1308
...
{
  "@odata.type": "#microsoft.graph.macOSWiFiConfiguration",
  "id": "66d46861-6861-66d4-6168-d4666168d466",
