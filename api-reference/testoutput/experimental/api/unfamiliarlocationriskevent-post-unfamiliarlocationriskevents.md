...
## Request body
In the request body, supply a JSON representation for the unfamiliarLocationRiskEvent object.

The following table shows the properties that are required when you create the unfamiliarLocationRiskEvent.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/unfamiliarLocationRiskEvents
Content-type: application/json
Content-length: 818
