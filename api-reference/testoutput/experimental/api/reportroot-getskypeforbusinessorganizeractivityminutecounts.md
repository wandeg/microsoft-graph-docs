...
-->
``` http
GET https://graph.microsoft.com/localtest/reports/getSkypeForBusinessOrganizerActivityMinuteCounts(period='parameterValue')
```
  ...
  "value": [
    {
      ...
      "id": "fe74a6b4-a6b4-fe74-b4a6-74feb4a674fe",
      "audioVideo": 10,
      "dialInMicrosoft": 15,
      "dialOutMicrosoft": 0,
