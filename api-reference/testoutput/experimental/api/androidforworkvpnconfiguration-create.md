...
## Request body
In the request body, supply a JSON representation for the [androidForWorkVpnConfiguration](../resources/androidforworkvpnconfiguration.md) object.
...
## Response
If successful, this method returns a `201 Created` response code and a [androidForWorkVpnConfiguration](../resources/androidforworkvpnconfiguration.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.androidForWorkVpnConfiguration not found
Content-type: application/json
Content-length: 1500
...
{
  "@odata.type": "#microsoft.graph.androidForWorkVpnConfiguration",
  "id": "80ee520c-520c-80ee-0c52-ee800c52ee80",
