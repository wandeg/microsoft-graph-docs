...
## Request body
In the request body, supply a JSON representation for the securityAction object.

The following table shows the properties that are required when you create the securityAction.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/Security/securityActions
Content-type: application/json
Content-length: 1143
