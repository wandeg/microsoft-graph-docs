---
title: "Add deviceIdentities"
description: "Add deviceIdentities by posting to the deviceIdentities collection."
author: ""
...
# Add deviceIdentities

Namespace: microsoft.graph

Add deviceIdentities by posting to the deviceIdentities collection.
...
-->
``` http
POST ** Collection URI for microsoft.graph.importedWindowsAutopilotDeviceIdentity not found/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.importedWindowsAutopilotDeviceIdentity not found
Content-type: application/json
Content-length: 678
