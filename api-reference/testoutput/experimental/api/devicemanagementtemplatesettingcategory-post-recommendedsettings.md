---
title: "Add recommendedSettings"
description: "Add recommendedSettings by posting to the recommendedSettings collection."
author: ""
...
Add recommendedSettings by posting to the recommendedSettings collection.
...
-->
``` http
POST /deviceManagement/templates/{deviceManagementTemplateId}/categories/{deviceManagementTemplateSettingCategoryId}/recommendedSettings/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/localtest/deviceManagement/templates/{deviceManagementTemplateId}/categories/{deviceManagementTemplateSettingCategoryId}/recommendedSettings
