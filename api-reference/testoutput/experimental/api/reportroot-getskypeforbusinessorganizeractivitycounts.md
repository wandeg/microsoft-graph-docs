...
-->
``` http
GET https://graph.microsoft.com/localtest/reports/getSkypeForBusinessOrganizerActivityCounts(period='parameterValue')
```
  ...
  "value": [
    {
      ...
      "id": "5aa0a126-a126-5aa0-26a1-a05a26a1a05a",
      "im": 2,
      "audioVideo": 10,
      "appSharing": 10,
      "web": 3,
