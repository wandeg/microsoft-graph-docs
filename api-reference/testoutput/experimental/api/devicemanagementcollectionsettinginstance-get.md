...
-->
``` http
GET ** Entity URI for microsoft.graph.deviceManagementCollectionSettingInstance not found
```
...
## Response
If successful, this method returns a `200 OK` response code and [deviceManagementCollectionSettingInstance](../resources/devicemanagementcollectionsettinginstance.md) object in the response body.
