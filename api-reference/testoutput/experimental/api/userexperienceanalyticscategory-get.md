...
-->
``` http
GET https://graph.microsoft.com/localtest/deviceManagement/userExperienceAnalyticsCategories/{userExperienceAnalyticsCategoryId}
```
...

{
  "value": {
    "@odata.type": "#microsoft.graph.userExperienceAnalyticsCategory",
    "id": "8809dc10-dc10-8809-10dc-098810dc0988",
    "insights": [
      {
