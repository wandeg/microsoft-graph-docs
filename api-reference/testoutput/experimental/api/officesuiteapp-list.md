...
List properties and relationships of the [officeSuiteApp](../resources/officesuiteapp.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.officeSuiteApp not found
```
