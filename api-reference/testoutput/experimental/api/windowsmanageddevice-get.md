...
Read properties and relationships of the [windowsManagedDevice](../resources/windowsmanageddevice.md) object.
...
## Response
If successful, this method returns a `200 OK` response code and [windowsManagedDevice](../resources/windowsmanageddevice.md) object in the response body.
...
-->
``` http
GET https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.windowsManagedDevice not found
```
