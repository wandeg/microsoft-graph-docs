...
## Request body
In the request body, supply a JSON representation for the [windowsAppX](../resources/windowsappx.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.windowsAppX not found
Content-type: application/json
Content-length: 1412
