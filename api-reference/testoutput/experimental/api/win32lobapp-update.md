...
## Request body
In the request body, supply a JSON representation for the [win32LobApp](../resources/win32lobapp.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/localtest** Entity URI for microsoft.graph.win32LobApp not found
