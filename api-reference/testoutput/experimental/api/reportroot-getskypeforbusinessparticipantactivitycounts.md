...
-->
``` http
GET https://graph.microsoft.com/localtest/reports/getSkypeForBusinessParticipantActivityCounts(period='parameterValue')
```
  ...
  "value": [
    {
      ...
      "id": "836b46e7-46e7-836b-e746-6b83e7466b83",
      "im": 2,
      "audioVideo": 10,
      "appSharing": 10,
      "web": 3,
