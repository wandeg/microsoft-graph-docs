...
## Request body
In the request body, supply a JSON representation for the [windowsPhone81SCEPCertificateProfile](../resources/windowsphone81scepcertificateprofile.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.windowsPhone81SCEPCertificateProfile not found
Content-type: application/json
Content-length: 1589
...
{
  "@odata.type": "#microsoft.graph.windowsPhone81SCEPCertificateProfile",
  "id": "c0d1db63-db63-c0d1-63db-d1c063dbd1c0",
