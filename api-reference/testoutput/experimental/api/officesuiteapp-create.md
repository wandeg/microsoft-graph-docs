...
## Request body
In the request body, supply a JSON representation for the [officeSuiteApp](../resources/officesuiteapp.md) object.
...
|productIds|Enumeration collection|The Product Ids that represent the Office365 Suite SKU. Possible values are: `o365ProPlusRetail`, `o365BusinessRetail`, `visioProRetail`, `projectProRetail`.|
...
## Response
If successful, this method returns a `201 Created` response code and a [officeSuiteApp](../resources/officesuiteapp.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.officeSuiteApp not found
Content-type: application/json
Content-length: 1587
...
{
  "@odata.type": "#microsoft.graph.officeSuiteApp",
  "id": "983f2912-2912-983f-1229-3f9812293f98",
  "displayName": "Display Name value",
  "description": "Description value",
  "publisher": "Publisher value",
  "largeIcon": {
