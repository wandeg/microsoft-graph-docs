...
description: "List properties and relationships of the groupPolicyDefinitionFile objects."
author: ""
...
List properties and relationships of the [groupPolicyDefinitionFile](../resources/grouppolicydefinitionfile.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/deviceManagement/groupPolicyDefinitionFiles
```
