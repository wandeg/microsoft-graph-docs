...
List properties and relationships of the [roleScopeTag](../resources/rolescopetag.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/deviceManagement/roleScopeTags
```
