...
description: "List properties and relationships of the groupPolicyDefinition objects."
author: ""
...
List properties and relationships of the [groupPolicyDefinition](../resources/grouppolicydefinition.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/deviceManagement/groupPolicyDefinitions
```
