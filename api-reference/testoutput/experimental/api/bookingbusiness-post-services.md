...
## Request body
In the request body, supply a JSON representation for the bookingService object.

The following table shows the properties that are required when you create the bookingService.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/bookingBusinesses/{bookingBusinessesId}/services
Content-type: application/json
Content-length: 1789
