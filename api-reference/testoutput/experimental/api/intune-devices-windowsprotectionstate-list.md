...
description: "List properties and relationships of the windowsProtectionState objects."
author: ""
...
List properties and relationships of the [windowsProtectionState](../resources/windowsprotectionstate.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest/deviceManagement/windowsMalwareInformation/{windowsMalwareInformationId}/windowsDevicesProtectionState
```
