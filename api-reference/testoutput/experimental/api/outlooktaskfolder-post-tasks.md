...
-->
``` http
POST /me/outlook/taskGroups/{outlookTaskGroupId}/taskFolders/{outlookTaskFolderId}/tasks/$ref
```
...
## Request body
In the request body, supply a JSON representation for the outlookTask object.

The following table shows the properties that are required when you create the outlookTask.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/me/outlook/taskGroups/{outlookTaskGroupId}/taskFolders/{outlookTaskFolderId}/tasks
Content-type: application/json
Content-length: 1570
