...
## Request body
In the request body, supply a JSON representation for the [windowsKioskConfiguration](../resources/windowskioskconfiguration.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.windowsKioskConfiguration not found
Content-type: application/json
Content-length: 2660
