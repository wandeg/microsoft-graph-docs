...
## Request body
In the request body, supply a JSON representation for the [windowsStoreApp](../resources/windowsstoreapp.md) object.
...
-->
``` http
POST https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.windowsStoreApp not found
Content-type: application/json
Content-length: 764
