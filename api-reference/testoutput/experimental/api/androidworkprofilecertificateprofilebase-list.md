...
List properties and relationships of the [androidWorkProfileCertificateProfileBase](../resources/androidworkprofilecertificateprofilebase.md) objects.
...
-->
``` http
GET https://graph.microsoft.com/localtest** Collection URI for microsoft.graph.androidWorkProfileCertificateProfileBase not found
```
  ...
  "value": [
    {
      ...
      "id": "0f16e6a3-e6a3-0f16-a3e6-160fa3e6160f",
