...
## Request body
In the request body, supply a JSON representation for the listItem object.

The following table shows the properties that are required when you create the listItem.
...
-->
``` http
POST https://graph.microsoft.com/docs\api/me/joinedGroups/{groupId}/drive/list/items
Content-type: application/json
Content-length: 1299
