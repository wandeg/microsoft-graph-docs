...
Update the properties of a [androidManagedStoreApp](../resources/androidmanagedstoreapp.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/docs\api** Entity URI for microsoft.graph.androidManagedStoreApp not found
