...
-->
``` http
GET https://graph.microsoft.com/localtest/reports/getAzureADLicenseUsage(period='parameterValue')
```
  ...
  "value": [
    {
      ...
      "id": "3a0dc888-c888-3a0d-88c8-0d3a88c80d3a",
      "snapshotDateTime": "2017-01-01T00:03:22.3702292+03:00",
      "licenseInfoDetails": [
        {
