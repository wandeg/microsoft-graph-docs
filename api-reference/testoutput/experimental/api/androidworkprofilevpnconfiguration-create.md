...
-->
``` http
POST https://graph.microsoft.com/docs\api** Collection URI for microsoft.graph.androidWorkProfileVpnConfiguration not found
Content-type: application/json
Content-length: 1504
...
{
  "@odata.type": "#microsoft.graph.androidWorkProfileVpnConfiguration",
  "id": "640fdfb0-dfb0-640f-b0df-0f64b0df0f64",
