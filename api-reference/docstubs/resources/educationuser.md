...
|[Remove schools](../api/educationuser-delete-schools.md)|None|Remove a schools object.|
...
|[Remove classes](../api/educationuser-delete-classes.md)|None|Remove a classes object.|
...
|[Remove user](../api/educationuser-delete-user.md)|None|Remove an user object.|
