...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/calendar/events/{eventId}/instances
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/calendar/events/{eventId}/instances
```
