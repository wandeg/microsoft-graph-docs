...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/planner/plans/{plannerPlanId}/details
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/planner/plans/{plannerPlanId}/details
...
{
  "@odata.type": "#microsoft.graph.plannerPlanDetails",
  "id": "8a18e6ce-e6ce-8a18-cee6-188acee6188a",
  "sharedWith": {
    "@odata.type": "microsoft.graph.plannerUserIds"
  },
  "categoryDescriptions": {
