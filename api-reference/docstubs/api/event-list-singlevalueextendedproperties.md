...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/messages/{messageId}/event/singleValueExtendedProperties
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/messages/{messageId}/event/singleValueExtendedProperties
```
