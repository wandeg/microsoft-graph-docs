...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/planner/recentPlans
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/planner/recentPlans
```
