...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/calendar/multiValueExtendedProperties
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/calendar/multiValueExtendedProperties
```
