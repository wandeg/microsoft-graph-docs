...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/profile/languages/{languageProficiencyId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/languages/{languageProficiencyId}
```
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.languageProficiency",
    "id": "0680424f-424f-0680-4f42-80064f428006",
