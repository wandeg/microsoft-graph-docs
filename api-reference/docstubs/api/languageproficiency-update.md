...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/profile/languages/{languageProficiencyId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/languages/{languageProficiencyId}
