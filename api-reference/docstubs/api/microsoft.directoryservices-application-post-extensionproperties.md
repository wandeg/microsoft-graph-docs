...
## Response
If successful, this method returns a `201 Created` response code and an [extensionProperty](../resources/microsoft.directoryservices-extensionproperty.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/changelog/applications/{applicationsId}/extensionProperties
