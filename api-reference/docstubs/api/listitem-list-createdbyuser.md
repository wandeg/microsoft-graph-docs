...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/drive/items/{driveItemId}/listItem/createdByUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/drive/items/{driveItemId}/listItem/createdByUser
```
