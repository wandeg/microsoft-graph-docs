...
description: "Update the properties of a classifyTextJobs object."
...
Update the properties of a classifyTextJobs object.
...
-->
``` http
PATCH /dataClassification/classifyTextJobs
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/dataClassification/classifyTextJobs
