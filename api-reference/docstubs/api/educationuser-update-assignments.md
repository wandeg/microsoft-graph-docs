...
-->
``` http
PATCH /education/classes/{educationClassId}/members/{educationUserId}/assignments
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/education/classes/{educationClassId}/members/{educationUserId}/assignments
