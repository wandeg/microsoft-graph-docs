---
title: "Update enrollmentProfiles"
description: "Update the properties of an enrollmentProfiles object."
...
# Update enrollmentProfiles

Namespace: microsoft.graph

Update the properties of an enrollmentProfiles object.
...
-->
``` http
PATCH /deviceManagement/depOnboardingSettings/{depOnboardingSettingId}/enrollmentProfiles
```
...
<!-- {
  "blockType": "request",
  "name": "update_enrollmentprofiles"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/depOnboardingSettings/{depOnboardingSettingId}/enrollmentProfiles
