...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/profile/webAccounts
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/webAccounts
