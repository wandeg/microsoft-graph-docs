...
Update the properties of a [appRoleAssignment](../resources/microsoft.directoryservices-approleassignment.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/changelog/appRoleAssignments/{appRoleAssignmentsId}
