...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/contacts/{contactId}/multiValueExtendedProperties
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/contacts/{contactId}/multiValueExtendedProperties
