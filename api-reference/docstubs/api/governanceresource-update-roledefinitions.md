...
-->
``` http
PATCH /governanceResources/{governanceResourcesId}/roleDefinitions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/governanceResources/{governanceResourcesId}/roleDefinitions
