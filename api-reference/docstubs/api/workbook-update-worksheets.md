...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/drive/items/{driveItemId}/workbook/worksheets
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/drive/items/{driveItemId}/workbook/worksheets
...
{
  "@odata.type": "#microsoft.graph.workbookWorksheet",
  "id": "85f2553a-553a-85f2-3a55-f2853a55f285",
  "name": "Name value",
  "position": 8,
  "visibility": "Visibility value"
}
