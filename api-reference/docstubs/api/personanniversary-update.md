...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/profile/anniversaries/{personAnniversaryId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/anniversaries/{personAnniversaryId}
...
{
  "@odata.type": "#microsoft.graph.personAnniversary",
  "id": "0ea2f0b5-f0b5-0ea2-b5f0-a20eb5f0a20e",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "microsoft.graph.inferenceData",
    "confidenceScore": "Double",
