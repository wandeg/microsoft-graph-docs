...
description: "Update the properties of an unitsOfMeasure object."
...
-->
``` http
PATCH /financials/companies/{companyId}/unitsOfMeasure
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/unitsOfMeasure
