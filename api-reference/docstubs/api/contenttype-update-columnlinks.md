...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/drive/list/contentTypes/{contentTypeId}/columnLinks
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/drive/list/contentTypes/{contentTypeId}/columnLinks
