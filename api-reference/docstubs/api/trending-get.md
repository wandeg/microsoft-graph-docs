---
title: "Get trending"
description: "Read properties and relationships of a trending object."
...
Read properties and relationships of a [trending](../resources/trending.md) object.
...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/insights/trending/{trendingId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/insights/trending/{trendingId}
```
