...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/authentication/methods
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/authentication/methods
```
