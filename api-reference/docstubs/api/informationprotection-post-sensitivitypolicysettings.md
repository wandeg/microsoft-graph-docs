...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/informationProtection/sensitivityPolicySettings
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/informationProtection/sensitivityPolicySettings
