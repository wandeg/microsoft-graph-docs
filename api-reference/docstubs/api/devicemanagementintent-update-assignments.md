...
-->
``` http
PATCH /deviceManagement/intents/{deviceManagementIntentId}/assignments
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/intents/{deviceManagementIntentId}/assignments
...
{
  "@odata.type": "#microsoft.graph.deviceManagementIntentAssignment",
  "id": "e82d69d6-69d6-e82d-d669-2de8d6692de8",
  "target": {
    "@odata.type": "microsoft.graph.deviceAndAppManagementAssignmentTarget"
  }
}
