...
Create a new [user](../resources/microsoft.directoryservices-user.md) object.
...
## Response
If successful, this method returns a `201 Created` response code and an [user](../resources/microsoft.directoryservices-user.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/changelog/users
