...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/userConfigurations
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/userConfigurations
```
