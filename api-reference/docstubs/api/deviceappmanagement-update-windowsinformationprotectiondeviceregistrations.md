---
title: "Update windowsInformationProtectionDeviceRegistrations"
description: "Update the properties of a windowsInformationProtectionDeviceRegistrations object."
...
Update the properties of a windowsInformationProtectionDeviceRegistrations object.
...
-->
``` http
PATCH /deviceAppManagement/windowsInformationProtectionDeviceRegistrations
```
...
<!-- {
  "blockType": "request",
  "name": "update_windowsinformationprotectiondeviceregistrations"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceAppManagement/windowsInformationProtectionDeviceRegistrations
...
{
  "@odata.type": "#microsoft.graph.windowsInformationProtectionDeviceRegistration",
  "id": "20e59abf-9abf-20e5-bf9a-e520bf9ae520",
  "userId": "User Id value",
  "deviceRegistrationId": "Device Registration Id value",
  "deviceName": "Device Name value",
  "deviceType": "Device Type value",
