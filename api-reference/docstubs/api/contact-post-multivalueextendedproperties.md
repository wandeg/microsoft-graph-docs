...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/contacts/{contactId}/multiValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/contacts/{contactId}/multiValueExtendedProperties
