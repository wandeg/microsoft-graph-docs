...
description: "Update the properties of an appliesTo object."
...
Update the properties of an appliesTo object.
...
-->
``` http
PATCH /directory/featureRolloutPolicies/{featureRolloutPolicyId}/appliesTo
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/directory/featureRolloutPolicies/{featureRolloutPolicyId}/appliesTo
