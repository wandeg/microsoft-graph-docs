...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/planner/tasks/{plannerTaskId}/assignedToTaskBoardFormat
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/planner/tasks/{plannerTaskId}/assignedToTaskBoardFormat
...
{
  "@odata.type": "#microsoft.graph.plannerAssignedToTaskBoardTaskFormat",
  "id": "f3691492-1492-f369-9214-69f3921469f3",
  "unassignedOrderHint": "Unassigned Order Hint value",
  "orderHintsByAssignee": {
    "@odata.type": "microsoft.graph.plannerOrderHintsByAssignee"
  }
