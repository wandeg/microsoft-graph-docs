...
## Response
If successful, this action returns a `200 OK` response code and a [user](../resources/microsoft.directoryservices-user.md) in the response body.
...
-->
``` http
POST https://graph.microsoft.com/changelog/me/reprocessLicenseAssignment
```
