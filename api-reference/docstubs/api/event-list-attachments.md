...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/calendar/events/{eventId}/attachments
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/calendar/events/{eventId}/attachments
```
