...
description: "Update the properties of a salesCreditMemos object."
...
Update the properties of a salesCreditMemos object.
...
-->
``` http
PATCH /financials/companies/{companyId}/salesCreditMemos
```
...
<!-- {
  "blockType": "request",
  "name": "update_salescreditmemos"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/salesCreditMemos
