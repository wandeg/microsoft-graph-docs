...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/authentication/phoneMethods
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/authentication/phoneMethods
```
