...
description: "Update the properties of a dimensions object."
...
Update the properties of a dimensions object.
...
-->
``` http
PATCH /financials/companies/{companyId}/dimensions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/dimensions
...
{
  "@odata.type": "#microsoft.graph.dimension",
  "id": "a378060e-060e-a378-0e06-78a30e0678a3",
  "code": "Code value",
  "displayName": "Display Name value",
