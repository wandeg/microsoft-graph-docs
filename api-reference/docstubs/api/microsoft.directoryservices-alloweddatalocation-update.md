...
Update the properties of a [allowedDataLocation](../resources/microsoft.directoryservices-alloweddatalocation.md) object.
...
## Response
If successful, this method returns a `200 OK` response code and an updated [allowedDataLocation](../resources/microsoft.directoryservices-alloweddatalocation.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/changelog/allowedDataLocations/{allowedDataLocationsId}
