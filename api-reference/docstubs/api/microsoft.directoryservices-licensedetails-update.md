...
Update the properties of a [licenseDetails](../resources/microsoft.directoryservices-licensedetails.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/changelog/me/licenseDetails/{licenseDetailsId}
