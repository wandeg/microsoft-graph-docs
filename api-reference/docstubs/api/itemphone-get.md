...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/profile/phones/{itemPhoneId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/phones/{itemPhoneId}
```
