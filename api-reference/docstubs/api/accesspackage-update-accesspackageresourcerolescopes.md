...
-->
``` http
PATCH /accessPackages/{accessPackagesId}/accessPackageResourceRoleScopes
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/accessPackages/{accessPackagesId}/accessPackageResourceRoleScopes
