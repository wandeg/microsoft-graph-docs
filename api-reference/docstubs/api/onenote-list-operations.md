...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/onenote/operations
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/onenote/operations
```
