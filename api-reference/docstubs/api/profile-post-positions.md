...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/profile/positions
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/positions
