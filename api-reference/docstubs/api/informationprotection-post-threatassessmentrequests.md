...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/informationProtection/threatAssessmentRequests
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/informationProtection/threatAssessmentRequests
