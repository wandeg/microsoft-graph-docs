...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/contacts/{contactId}/photo
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/contacts/{contactId}/photo
...
{
  "@odata.type": "#microsoft.graph.profilePhoto",
  "id": "e62c102c-102c-e62c-2c10-2ce62c102ce6",
  "height": 6,
  "width": 5
}
```
