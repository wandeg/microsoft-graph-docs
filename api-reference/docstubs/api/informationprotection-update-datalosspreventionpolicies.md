...
description: "Update the properties of a dataLossPreventionPolicies object."
...
Update the properties of a dataLossPreventionPolicies object.
...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/informationProtection/dataLossPreventionPolicies
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/informationProtection/dataLossPreventionPolicies
...
{
  "@odata.type": "#microsoft.graph.dataLossPreventionPolicy",
  "id": "f04c77c0-77c0-f04c-c077-4cf0c0774cf0",
  "name": "Name value"
}
```
