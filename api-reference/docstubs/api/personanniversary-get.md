...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/profile/anniversaries/{personAnniversaryId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/anniversaries/{personAnniversaryId}
```
