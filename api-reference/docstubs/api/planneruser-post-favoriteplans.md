...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/planner/favoritePlans/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/planner/favoritePlans/$ref
