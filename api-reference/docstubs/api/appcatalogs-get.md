...
description: "Read properties and relationships of an appCatalogs object."
...
Read properties and relationships of an [appCatalogs](../resources/appcatalogs.md) object.
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.appCatalogs",
    "id": "d37803c0-03c0-d378-c003-78d3c00378d3"
  }
}
```
