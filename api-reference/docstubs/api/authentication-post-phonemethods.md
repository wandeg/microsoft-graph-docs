...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/authentication/phoneMethods
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/authentication/phoneMethods
