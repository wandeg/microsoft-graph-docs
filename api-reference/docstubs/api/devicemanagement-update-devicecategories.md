---
title: "Update deviceCategories"
description: "Update the properties of a deviceCategories object."
...
Update the properties of a deviceCategories object.
...
-->
``` http
PATCH /deviceManagement/deviceCategories
```
...
<!-- {
  "blockType": "request",
  "name": "update_devicecategories"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/deviceCategories
