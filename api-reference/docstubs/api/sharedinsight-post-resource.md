...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/insights/shared/{sharedInsightId}/resource/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/insights/shared/{sharedInsightId}/resource/$ref
