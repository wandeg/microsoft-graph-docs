...
-->
``` http
POST /accessPackageAssignments/{accessPackageAssignmentsId}/target
```
...
-->
``` http
POST https://graph.microsoft.com/beta/accessPackageAssignments/{accessPackageAssignmentsId}/target
