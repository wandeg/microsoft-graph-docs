...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/planner/plans/{plannerPlanId}/tasks/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/planner/plans/{plannerPlanId}/tasks/$ref
