...
-->
``` http
GET /leakedCredentialsRiskEvents/{leakedCredentialsRiskEventsId}/impactedUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/leakedCredentialsRiskEvents/{leakedCredentialsRiskEventsId}/impactedUser
```
