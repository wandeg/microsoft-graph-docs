...
-->
``` http
PATCH /governanceResources/{governanceResourcesId}/roleSettings
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/governanceResources/{governanceResourcesId}/roleSettings
