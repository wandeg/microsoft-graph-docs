...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/authentication/passwordMethods
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/authentication/passwordMethods
```
