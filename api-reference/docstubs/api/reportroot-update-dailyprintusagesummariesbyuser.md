---
title: "Update dailyPrintUsageSummariesByUser"
description: "Update the properties of a dailyPrintUsageSummariesByUser object."
...
# Update dailyPrintUsageSummariesByUser

Namespace: microsoft.graph

Update the properties of a dailyPrintUsageSummariesByUser object.
...
-->
``` http
PATCH /reports/dailyPrintUsageSummariesByUser
```
...
<!-- {
  "blockType": "request",
  "name": "update_dailyprintusagesummariesbyuser"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/reports/dailyPrintUsageSummariesByUser
