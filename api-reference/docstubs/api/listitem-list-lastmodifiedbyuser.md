...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/drive/items/{driveItemId}/listItem/lastModifiedByUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/drive/items/{driveItemId}/listItem/lastModifiedByUser
```
