...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/messages/{messageId}/multiValueExtendedProperties
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/messages/{messageId}/multiValueExtendedProperties
```
