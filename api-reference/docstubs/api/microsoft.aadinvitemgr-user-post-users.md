...
Create a new [user](../resources/microsoft.aadinvitemgr-user.md) object.
...
## Response
If successful, this method returns a `201 Created` response code and an [user](../resources/microsoft.aadinvitemgr-user.md) object in the response body.
