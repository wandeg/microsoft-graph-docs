...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/contactFolders/{contactFolderId}/childFolders
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/contactFolders/{contactFolderId}/childFolders
```
