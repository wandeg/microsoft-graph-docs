...
-->
``` http
POST /financials/companies/{companyId}/customers/{customerId}/currency
```
...
-->
``` http
POST https://graph.microsoft.com/beta/financials/companies/{companyId}/customers/{customerId}/currency
