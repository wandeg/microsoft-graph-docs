...
-->
``` http
POST /me/messages/{messageId}/event/attachments/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/me/messages/{messageId}/event/attachments
...
{
  "@odata.type": "#microsoft.graph.attachment",
  "id": "0cb95f6f-5f6f-0cb9-6f5f-b90c6f5fb90c",
