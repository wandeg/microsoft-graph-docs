...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/onenote/resources/{onenoteResourceId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/onenote/resources/{onenoteResourceId}
