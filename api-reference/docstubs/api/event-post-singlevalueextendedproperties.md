...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/calendar/events/{eventId}/singleValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/calendar/events/{eventId}/singleValueExtendedProperties
