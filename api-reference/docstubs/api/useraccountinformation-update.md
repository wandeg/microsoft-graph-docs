...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/profile/account/{userAccountInformationId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/account/{userAccountInformationId}
