...
-->
``` http
POST /financials/companies/{companyId}/vendors/{vendorId}/currency
```
...
-->
``` http
POST https://graph.microsoft.com/beta/financials/companies/{companyId}/vendors/{vendorId}/currency
