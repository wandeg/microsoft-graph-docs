...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/profile/educationalActivities/{educationalActivityId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/educationalActivities/{educationalActivityId}
