...
## Response
If successful, this function returns a `200 OK` response code and a [group](../resources/microsoft.directoryservices-group.md) collection in the response body.
...
-->
``` http
GET https://graph.microsoft.com/changelog/groups/delta
```
