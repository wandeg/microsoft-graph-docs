...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/profile/projects/{projectParticipationId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/projects/{projectParticipationId}
