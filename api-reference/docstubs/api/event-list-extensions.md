...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/messages/{messageId}/event/extensions
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/messages/{messageId}/event/extensions
```
