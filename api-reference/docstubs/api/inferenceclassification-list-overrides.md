...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/inferenceClassification/overrides
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/inferenceClassification/overrides
```
