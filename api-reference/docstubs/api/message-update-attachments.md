...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/messages/{messageId}/attachments
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/messages/{messageId}/attachments
