...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/userConfigurations/{userConfigurationId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/userConfigurations/{userConfigurationId}
```
