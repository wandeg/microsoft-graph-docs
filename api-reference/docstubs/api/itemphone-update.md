...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/profile/phones/{itemPhoneId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/phones/{itemPhoneId}
