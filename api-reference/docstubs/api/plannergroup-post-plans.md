...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/planner/plans/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/planner/plans/$ref
...
{
  "@odata.type": "#microsoft.graph.plannerPlan",
  "id": "3e9f66c0-66c0-3e9f-c066-9f3ec0669f3e",
  "createdBy": {
    "@odata.type": "microsoft.graph.identitySet",
    "application": {
      "@odata.type": "microsoft.graph.identity",
