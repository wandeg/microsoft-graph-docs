...
description: "Create a new allowedGroups object."
...
Create a new allowedGroups object.
...
-->
``` http
POST /print/printers/{printerId}/share/allowedGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/print/printers/{printerId}/share/allowedGroups
