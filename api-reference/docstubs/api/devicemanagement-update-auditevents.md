---
title: "Update auditEvents"
description: "Update the properties of an auditEvents object."
...
Update the properties of an auditEvents object.
...
-->
``` http
PATCH /deviceManagement/auditEvents
```
...
<!-- {
  "blockType": "request",
  "name": "update_auditevents"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/auditEvents
