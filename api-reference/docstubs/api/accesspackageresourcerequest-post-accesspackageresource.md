...
-->
``` http
POST /accessPackageResourceRequests/{accessPackageResourceRequestsId}/accessPackageResource/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/accessPackageResourceRequests/{accessPackageResourceRequestsId}/accessPackageResource/$ref
