---
title: "Update dailyPrintUsageSummariesByPrinter"
description: "Update the properties of a dailyPrintUsageSummariesByPrinter object."
...
# Update dailyPrintUsageSummariesByPrinter

Namespace: microsoft.graph

Update the properties of a dailyPrintUsageSummariesByPrinter object.
...
-->
``` http
PATCH /reports/dailyPrintUsageSummariesByPrinter
```
...
<!-- {
  "blockType": "request",
  "name": "update_dailyprintusagesummariesbyprinter"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/reports/dailyPrintUsageSummariesByPrinter
