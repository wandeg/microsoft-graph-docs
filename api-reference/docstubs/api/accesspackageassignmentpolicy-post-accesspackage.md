...
-->
``` http
POST /accessPackageAssignmentPolicies/{accessPackageAssignmentPoliciesId}/accessPackage/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/accessPackageAssignmentPolicies/{accessPackageAssignmentPoliciesId}/accessPackage/$ref
