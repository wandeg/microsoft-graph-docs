...
-->
``` http
PATCH /financials/companies/{companyId}/customers/{customerId}/picture
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/customers/{customerId}/picture
