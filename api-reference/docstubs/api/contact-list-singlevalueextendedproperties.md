...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/contacts/{contactId}/singleValueExtendedProperties
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/contacts/{contactId}/singleValueExtendedProperties
```
