...
PATCH /invitations/{invitationsId}/invitedUser/drive/list/columns/{columnDefinitionId}
PATCH /invitations/{invitationsId}/invitedUser/joinedTeams/{groupId}/sites/{siteId}/columns/{columnDefinitionId}
```
