...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/profile/account/{userAccountInformationId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/account/{userAccountInformationId}
```
