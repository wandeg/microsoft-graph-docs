...
-->
``` http
GET /suspiciousIpRiskEvents/{suspiciousIpRiskEventsId}/impactedUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/suspiciousIpRiskEvents/{suspiciousIpRiskEventsId}/impactedUser
```
