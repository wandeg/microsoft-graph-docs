...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/calendarGroups/{calendarGroupId}/calendars
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/calendarGroups/{calendarGroupId}/calendars
...
{
  "@odata.type": "#microsoft.graph.calendar",
  "id": "029374ba-74ba-0293-ba74-9302ba749302",
  "name": "Name value",
  "color": "String",
  "hexColor": "Hex Color value",
  "isDefaultCalendar": true,
