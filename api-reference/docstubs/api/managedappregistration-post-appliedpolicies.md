...
description: "Create a new appliedPolicies object."
...
Create a new appliedPolicies object.
...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/managedAppRegistrations/{managedAppRegistrationId}/appliedPolicies
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/managedAppRegistrations/{managedAppRegistrationId}/appliedPolicies
