...
-->
``` http
POST /accessPackages/{accessPackagesId}/accessPackageCatalog/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/accessPackages/{accessPackagesId}/accessPackageCatalog/$ref
