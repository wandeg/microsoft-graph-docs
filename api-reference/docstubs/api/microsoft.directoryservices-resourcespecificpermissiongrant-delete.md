...
Deletes a [resourceSpecificPermissionGrant](../resources/microsoft.directoryservices-resourcespecificpermissiongrant.md).
...
-->
``` http
DELETE https://graph.microsoft.com/changelog/permissionGrants/{permissionGrantsId}
```
