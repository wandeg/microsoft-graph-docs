...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/profile/websites/{personWebsiteId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/websites/{personWebsiteId}
