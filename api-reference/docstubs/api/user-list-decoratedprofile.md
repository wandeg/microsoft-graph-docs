---
title: "List decoratedProfile"
description: "Get the DecoratedProfiles from the decoratedProfile navigation property."
...
# List decoratedProfile

Namespace: microsoft.graph

Get the DecoratedProfiles from the decoratedProfile navigation property.
...
-->
``` http
GET /me/decoratedProfile
GET /users/{usersId}/decoratedProfile
```
...
-->
``` http
GET https://graph.microsoft.com/beta/me/decoratedProfile
```
  ...
  "value": [
    {
      ...
      "id": "8e5640c3-40c3-8e56-c340-568ec340568e",
