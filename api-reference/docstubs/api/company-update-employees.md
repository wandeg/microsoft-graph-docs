...
description: "Update the properties of an employees object."
...
Update the properties of an employees object.
...
-->
``` http
PATCH /financials/companies/{companyId}/employees
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/employees
