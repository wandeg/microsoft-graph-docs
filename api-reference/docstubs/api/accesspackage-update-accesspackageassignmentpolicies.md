...
-->
``` http
PATCH /accessPackages/{accessPackagesId}/accessPackageAssignmentPolicies
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/accessPackages/{accessPackagesId}/accessPackageAssignmentPolicies
