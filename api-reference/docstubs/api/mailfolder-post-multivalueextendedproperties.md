...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/multiValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/multiValueExtendedProperties
