...
-->
``` http
GET /impossibleTravelRiskEvents/{impossibleTravelRiskEventsId}/impactedUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/impossibleTravelRiskEvents/{impossibleTravelRiskEventsId}/impactedUser
```
