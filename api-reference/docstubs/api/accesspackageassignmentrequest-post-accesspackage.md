...
-->
``` http
POST /accessPackageAssignmentRequests/{accessPackageAssignmentRequestsId}/accessPackage/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/accessPackageAssignmentRequests/{accessPackageAssignmentRequestsId}/accessPackage/$ref
