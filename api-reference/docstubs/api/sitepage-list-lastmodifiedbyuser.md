...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/sites/{siteId}/items/{baseItemId}/lastModifiedByUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/sites/{siteId}/items/{baseItemId}/lastModifiedByUser
```
