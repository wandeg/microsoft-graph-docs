...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/profile/webAccounts
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/webAccounts
```
