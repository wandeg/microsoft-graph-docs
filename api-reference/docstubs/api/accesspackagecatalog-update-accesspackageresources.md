...
-->
``` http
PATCH /accessPackageCatalogs/{accessPackageCatalogsId}/accessPackageResources
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/accessPackageCatalogs/{accessPackageCatalogsId}/accessPackageResources
