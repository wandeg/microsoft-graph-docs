...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/joinedTeams/{groupId}/team/installedApps/{teamsAppInstallationId}/teamsAppDefinition
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedTeams/{groupId}/team/installedApps/{teamsAppInstallationId}/teamsAppDefinition
```
