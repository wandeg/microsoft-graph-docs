...
-->
``` http
GET /unfamiliarLocationRiskEvents/{unfamiliarLocationRiskEventsId}/impactedUser
```
...
-->
``` http
GET https://graph.microsoft.com/beta/unfamiliarLocationRiskEvents/{unfamiliarLocationRiskEventsId}/impactedUser
```
