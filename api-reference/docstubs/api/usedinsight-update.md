...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/insights/used/{usedInsightId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/insights/used/{usedInsightId}
