...
-->
``` http
POST /unfamiliarLocationRiskEvents/{unfamiliarLocationRiskEventsId}/impactedUser/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/unfamiliarLocationRiskEvents/{unfamiliarLocationRiskEventsId}/impactedUser/$ref
