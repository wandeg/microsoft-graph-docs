...
description: "Create a new appScopes object."
...
-->
``` http
POST /roleManagement/deviceManagement/roleAssignments/{unifiedRoleAssignmentMultipleId}/appScopes
```
