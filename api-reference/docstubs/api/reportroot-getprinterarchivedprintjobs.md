...
-->
``` http
GET https://graph.microsoft.com/beta/print/reports/getPrinterArchivedPrintJobs(printerId='parameterValue',periodStart=01/01/2017 00:01:32 +03:00,periodEnd=31/12/2016 23:58:30 +03:00)
```
