...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/profile/names/{personNameId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/names/{personNameId}
