...
Update the properties of a [servicePrincipal](../resources/microsoft.directoryservices-serviceprincipal.md) object.
...
## Response
If successful, this method returns a `200 OK` response code and an updated [servicePrincipal](../resources/microsoft.directoryservices-serviceprincipal.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/changelog/servicePrincipals/{servicePrincipalsId}
