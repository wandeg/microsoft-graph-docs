...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/profile/projects/{projectParticipationId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/projects/{projectParticipationId}
```
