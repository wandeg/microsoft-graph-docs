...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/contactFolders/{contactFolderId}/childFolders
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/contactFolders/{contactFolderId}/childFolders
...
{
  "@odata.type": "#microsoft.graph.contactFolder",
  "id": "1a4b78de-78de-1a4b-de78-4b1ade784b1a",
  "parentFolderId": "Parent Folder Id value",
  "displayName": "Display Name value"
}
```
