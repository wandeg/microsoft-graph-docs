...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/drive/list/contentTypes/{contentTypeId}/columnLinks
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/drive/list/contentTypes/{contentTypeId}/columnLinks
```
