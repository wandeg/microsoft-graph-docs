...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/onenote/notebooks/{notebookId}/sectionGroups
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/onenote/notebooks/{notebookId}/sectionGroups
