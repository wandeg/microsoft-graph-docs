...
description: "Create a new sublabels object."
...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/informationProtection/sensitivityLabels/{sensitivityLabelId}/sublabels
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/informationProtection/sensitivityLabels/{sensitivityLabelId}/sublabels
