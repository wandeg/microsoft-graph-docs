...
Read properties and relationships of a [resourceSpecificPermissionGrant](../resources/microsoft.directoryservices-resourcespecificpermissiongrant.md) object.
...
## Response
If successful, this method returns a `200 OK` response code and a [resourceSpecificPermissionGrant](../resources/microsoft.directoryservices-resourcespecificpermissiongrant.md) object in the response body.
...
-->
``` http
GET https://graph.microsoft.com/changelog/permissionGrants/{permissionGrantsId}
```
