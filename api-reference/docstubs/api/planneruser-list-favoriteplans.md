...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/planner/favoritePlans
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/planner/favoritePlans
```
