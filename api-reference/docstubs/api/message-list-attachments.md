...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/messages/{messageId}/attachments
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/messages/{messageId}/attachments
```
