...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/messageRules/{messageRuleId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/messageRules/{messageRuleId}
...
{
  "@odata.type": "#microsoft.graph.messageRule",
  "id": "7a157171-7171-7a15-7171-157a7171157a",
  "displayName": "Display Name value",
  "sequence": 8,
  "conditions": {
    "@odata.type": "microsoft.graph.messageRulePredicates",
