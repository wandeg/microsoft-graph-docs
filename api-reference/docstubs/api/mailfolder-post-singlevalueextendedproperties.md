...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/singleValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/singleValueExtendedProperties
