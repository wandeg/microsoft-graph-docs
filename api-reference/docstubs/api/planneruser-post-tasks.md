...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/planner/tasks/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/planner/tasks/$ref
