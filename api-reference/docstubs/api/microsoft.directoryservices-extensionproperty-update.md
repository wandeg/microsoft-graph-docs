...
Update the properties of a [extensionProperty](../resources/microsoft.directoryservices-extensionproperty.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/changelog/applications/{applicationsId}/extensionProperties/{extensionPropertyId}
