...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/outlook/masterCategories/{outlookCategoryId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/outlook/masterCategories/{outlookCategoryId}
...
{
  "@odata.type": "#microsoft.graph.outlookCategory",
  "id": "3b3dcd65-cd65-3b3d-65cd-3d3b65cd3d3b",
  "displayName": "Display Name value",
  "color": "String"
}
```
