...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/onenote/sectionGroups
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/onenote/sectionGroups
```
