...
-->
``` http
PATCH /accessPackageResources/{accessPackageResourcesId}/accessPackageResourceRoles
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/accessPackageResources/{accessPackageResourcesId}/accessPackageResourceRoles
