---
title: "Update policyStatusDetails"
description: "Update the properties of a policyStatusDetails object."
...
# Update policyStatusDetails

Namespace: microsoft.graph

Update the properties of a policyStatusDetails object.
...
-->
``` http
PATCH /deviceManagement/autopilotEvents/{deviceManagementAutopilotEventId}/policyStatusDetails
```
...
<!-- {
  "blockType": "request",
  "name": "update_policystatusdetails"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/autopilotEvents/{deviceManagementAutopilotEventId}/policyStatusDetails
