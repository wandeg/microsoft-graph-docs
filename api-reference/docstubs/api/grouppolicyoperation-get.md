...
-->
``` http
GET ** Entity URI for microsoft.graph.groupPolicyOperation not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Entity URI for microsoft.graph.groupPolicyOperation not found
```
