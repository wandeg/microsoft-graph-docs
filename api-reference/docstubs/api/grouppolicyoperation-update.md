...
-->
``` http
PATCH ** Entity URI for microsoft.graph.groupPolicyOperation not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Entity URI for microsoft.graph.groupPolicyOperation not found
