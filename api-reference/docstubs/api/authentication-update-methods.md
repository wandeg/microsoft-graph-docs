...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/authentication/methods
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/authentication/methods
