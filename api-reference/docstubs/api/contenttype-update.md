...
PATCH /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/drive/list/contentTypes/{contentTypeId}
PATCH /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/sites/{siteId}/contentTypes/{contentTypeId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/sites/{sitesId}/contentTypes/{contentTypeId}
