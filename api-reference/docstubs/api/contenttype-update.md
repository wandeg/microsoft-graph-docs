...
PATCH /invitations/{invitationsId}/invitedUser/drive/list/contentTypes/{contentTypeId}
PATCH /invitations/{invitationsId}/invitedUser/joinedTeams/{groupId}/sites/{siteId}/contentTypes/{contentTypeId}
```
