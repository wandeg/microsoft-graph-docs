...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/onenote/notebooks/{notebookId}/sectionGroups
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/onenote/notebooks/{notebookId}/sectionGroups
