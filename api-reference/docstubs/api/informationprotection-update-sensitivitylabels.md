...
description: "Update the properties of a sensitivityLabels object."
...
Update the properties of a sensitivityLabels object.
...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/informationProtection/sensitivityLabels
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/informationProtection/sensitivityLabels
