...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/contacts/{contactId}/extensions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/contacts/{contactId}/extensions
