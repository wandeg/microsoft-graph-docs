...
-->
``` http
POST /applications/{applicationsId}/claimsMappingPolicies/{claimsMappingPolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/applications/{applicationsId}/claimsMappingPolicies/{claimsMappingPolicyId}/appliesTo/$ref
