...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/drive/list/items
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/drive/list/items
...
{
  "@odata.type": "#microsoft.graph.listItem",
  "id": "33763a03-3a03-3376-033a-7633033a7633",
  "createdBy": {
    "@odata.type": "microsoft.graph.identitySet",
    "application": {
      "@odata.type": "microsoft.graph.identity",
