...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/informationProtection/policy/labels/evaluateRemoval
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/informationProtection/policy/labels/evaluateRemoval
