...
description: "Read properties and relationships of a servicePrincipal object."
...
Read properties and relationships of a [servicePrincipal](../resources/microsoft.directoryservices-serviceprincipal.md) object.
...
## Response
If successful, this method returns a `200 OK` response code and a [servicePrincipal](../resources/microsoft.directoryservices-serviceprincipal.md) object in the response body.
...
-->
``` http
GET https://graph.microsoft.com/changelog/servicePrincipals/{servicePrincipalsId}
```
