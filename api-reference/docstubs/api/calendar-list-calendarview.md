...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/calendar/calendarView
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/calendar/calendarView
```
