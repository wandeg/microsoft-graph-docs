...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/approvals/{approvalId}/request/approval
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/approvals/{approvalId}/request/approval
...
{
  "@odata.type": "#microsoft.graph.approval",
  "id": "5fa3b8fe-b8fe-5fa3-feb8-a35ffeb8a35f"
}
```
