...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/messages/{messageId}/extensions
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/messages/{messageId}/extensions
