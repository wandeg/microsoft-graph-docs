...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/calendar/events/{eventId}/calendar
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/calendar/events/{eventId}/calendar
...
{
  "@odata.type": "#microsoft.graph.calendar",
  "id": "7f7bdf7f-df7f-7f7b-7fdf-7b7f7fdf7b7f",
  "name": "Name value",
  "color": "String",
  "changeKey": "Change Key value",
  "canShare": true,
