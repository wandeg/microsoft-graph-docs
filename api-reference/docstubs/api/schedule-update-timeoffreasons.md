---
title: "Update timeOffReasons"
description: "Update the properties of a timeOffReasons object."
...
# Update timeOffReasons

Namespace: microsoft.graph

Update the properties of a timeOffReasons object.
...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/schedule/timeOffReasons
```
...
<!-- {
  "blockType": "request",
  "name": "update_timeoffreasons"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/schedule/timeOffReasons
