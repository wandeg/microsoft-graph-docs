---
title: "Create openShiftChangeRequests"
description: "Create a new openShiftChangeRequests object."
...
# Create openShiftChangeRequests

Namespace: microsoft.graph

Create a new openShiftChangeRequests object.
...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/schedule/openShiftChangeRequests
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/schedule/openShiftChangeRequests
