...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/authentication/methods/{authenticationMethodId}/resetPassword
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/authentication/methods/{authenticationMethodId}/resetPassword
