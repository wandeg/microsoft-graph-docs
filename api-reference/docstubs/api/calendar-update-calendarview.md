...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/calendar/calendarView
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/calendar/calendarView
