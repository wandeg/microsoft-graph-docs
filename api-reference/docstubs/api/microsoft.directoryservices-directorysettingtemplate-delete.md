...
Deletes a [directorySettingTemplate](../resources/microsoft.directoryservices-directorysettingtemplate.md).
...
-->
``` http
DELETE https://graph.microsoft.com/changelog/directorySettingTemplates/{directorySettingTemplatesId}
```
