...
-->
``` http
PATCH /governanceResources/{governanceResourcesId}/roleAssignments
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/governanceResources/{governanceResourcesId}/roleAssignments
