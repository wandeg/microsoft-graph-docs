---
title: "Update timeOffRequests"
description: "Update the properties of a timeOffRequests object."
...
Update the properties of a timeOffRequests object.
...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/schedule/timeOffRequests
```
...
<!-- {
  "blockType": "request",
  "name": "update_timeoffrequests"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/schedule/timeOffRequests
