...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/contactFolders/{contactFolderId}/singleValueExtendedProperties
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/contactFolders/{contactFolderId}/singleValueExtendedProperties
...
{
  "@odata.type": "#microsoft.graph.singleValueLegacyExtendedProperty",
  "id": "cd301838-1838-cd30-3818-30cd381830cd",
  "value": "Value value"
}
```
