...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/informationProtection/policy/labels
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/informationProtection/policy/labels
```
