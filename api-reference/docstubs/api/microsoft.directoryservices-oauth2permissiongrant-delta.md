...
## Response
If successful, this function returns a `200 OK` response code and a [oAuth2PermissionGrant](../resources/microsoft.directoryservices-oauth2permissiongrant.md) collection in the response body.
...
-->
``` http
GET https://graph.microsoft.com/changelog/oauth2PermissionGrants/delta
```
