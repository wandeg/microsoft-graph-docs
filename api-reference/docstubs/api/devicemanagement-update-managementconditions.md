---
title: "Update managementConditions"
description: "Update the properties of a managementConditions object."
...
# Update managementConditions

Namespace: microsoft.graph

Update the properties of a managementConditions object.
...
-->
``` http
PATCH /deviceManagement/managementConditions
```
...
<!-- {
  "blockType": "request",
  "name": "update_managementconditions"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/managementConditions
