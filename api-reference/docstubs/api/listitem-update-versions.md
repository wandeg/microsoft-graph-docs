...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/drive/items/{driveItemId}/listItem/versions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/drive/items/{driveItemId}/listItem/versions
...
{
  "@odata.type": "#microsoft.graph.listItemVersion",
  "id": "622070cf-70cf-6220-cf70-2062cf702062",
  "lastModifiedBy": {
