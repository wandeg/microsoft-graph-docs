...
description: "Update the properties of a salesQuotes object."
...
Update the properties of a salesQuotes object.
...
-->
``` http
PATCH /financials/companies/{companyId}/salesQuotes
```
...
<!-- {
  "blockType": "request",
  "name": "update_salesquotes"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/salesQuotes
