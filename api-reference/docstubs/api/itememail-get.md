...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/profile/emails/{itemEmailId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/emails/{itemEmailId}
```
