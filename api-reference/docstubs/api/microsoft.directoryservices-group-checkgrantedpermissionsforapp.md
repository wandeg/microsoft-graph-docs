...
## Response
If successful, this action returns a `200 OK` response code and a [resourceSpecificPermissionGrant](../resources/microsoft.directoryservices-resourcespecificpermissiongrant.md) collection in the response body.
...
-->
``` http
POST https://graph.microsoft.com/changelog/groups/{groupsId}/checkGrantedPermissionsForApp
```
