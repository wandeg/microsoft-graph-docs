...
-->
``` http
POST /leakedCredentialsRiskEvents/{leakedCredentialsRiskEventsId}/impactedUser/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/leakedCredentialsRiskEvents/{leakedCredentialsRiskEventsId}/impactedUser/$ref
