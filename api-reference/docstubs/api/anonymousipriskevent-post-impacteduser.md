...
-->
``` http
POST /anonymousIpRiskEvents/{anonymousIpRiskEventsId}/impactedUser/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/anonymousIpRiskEvents/{anonymousIpRiskEventsId}/impactedUser/$ref
