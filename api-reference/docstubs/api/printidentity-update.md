...
-->
``` http
PATCH /print/printers/{printerId}/allowedGroups/{printIdentityId}
PATCH /print/printers/{printerId}/share/allowedGroups/{printIdentityId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/print/printers/{printerId}/allowedGroups/{printIdentityId}
