...
Update the properties of a [orgContact](../resources/microsoft.directoryservices-orgcontact.md) object.
...
## Response
If successful, this method returns a `200 OK` response code and an updated [orgContact](../resources/microsoft.directoryservices-orgcontact.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/changelog/contacts/{contactsId}
