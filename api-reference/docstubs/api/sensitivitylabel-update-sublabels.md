...
description: "Update the properties of a sublabels object."
...
Update the properties of a sublabels object.
...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/informationProtection/sensitivityLabels/{sensitivityLabelId}/sublabels
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/informationProtection/sensitivityLabels/{sensitivityLabelId}/sublabels
