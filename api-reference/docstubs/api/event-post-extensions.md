...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/messages/{messageId}/event/extensions
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/messages/{messageId}/event/extensions
