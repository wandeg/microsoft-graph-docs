...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/settings/shiftPreferences
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/settings/shiftPreferences
