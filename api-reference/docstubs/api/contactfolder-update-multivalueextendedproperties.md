...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/contactFolders/{contactFolderId}/multiValueExtendedProperties
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/contactFolders/{contactFolderId}/multiValueExtendedProperties
