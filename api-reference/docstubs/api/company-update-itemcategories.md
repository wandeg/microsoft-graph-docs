...
description: "Update the properties of an itemCategories object."
...
Update the properties of an itemCategories object.
...
-->
``` http
PATCH /financials/companies/{companyId}/itemCategories
```
...
<!-- {
  "blockType": "request",
  "name": "update_itemcategories"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/itemCategories
...
{
  "@odata.type": "#microsoft.graph.itemCategory",
  "id": "435467e9-67e9-4354-e967-5443e9675443",
  "code": "Code value",
  "displayName": "Display Name value",
