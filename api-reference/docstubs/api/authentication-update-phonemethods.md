...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/authentication/phoneMethods
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/authentication/phoneMethods
