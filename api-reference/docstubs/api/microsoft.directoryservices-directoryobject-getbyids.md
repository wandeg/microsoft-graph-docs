...
## Response
If successful, this action returns a `200 OK` response code and a [directoryObject](../resources/microsoft.directoryservices-directoryobject.md) collection in the response body.
...
-->
``` http
POST https://graph.microsoft.com/changelog/directoryObjects/getByIds
