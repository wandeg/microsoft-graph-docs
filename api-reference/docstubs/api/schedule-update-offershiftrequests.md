---
title: "Update offerShiftRequests"
description: "Update the properties of an offerShiftRequests object."
...
# Update offerShiftRequests

Namespace: microsoft.graph

Update the properties of an offerShiftRequests object.
...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/schedule/offerShiftRequests
```
...
<!-- {
  "blockType": "request",
  "name": "update_offershiftrequests"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/schedule/offerShiftRequests
