...
description: "Read properties and relationships of an usedInsight object."
...
Read properties and relationships of an [usedInsight](../resources/usedinsight.md) object.
...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/insights/used/{usedInsightId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/insights/used/{usedInsightId}
```
