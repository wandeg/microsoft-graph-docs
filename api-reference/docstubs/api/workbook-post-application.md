...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/workbook/application
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/drive/activities/{itemActivityOLDId}/driveItem/workbook/application
...
{
  "@odata.type": "#microsoft.graph.workbookApplication",
  "id": "8ede8d1b-8d1b-8ede-1b8d-de8e1b8dde8e",
  "calculationMode": "Calculation Mode value"
}
```
