...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/planner/plans/{plannerPlanId}/buckets
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/planner/plans/{plannerPlanId}/buckets
```
  ...
  "value": [
    {
      ...
      "id": "7bf7b8c4-b8c4-7bf7-c4b8-f77bc4b8f77b",
      "name": "Name value",
