...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/drive/list/columns
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/drive/list/columns
