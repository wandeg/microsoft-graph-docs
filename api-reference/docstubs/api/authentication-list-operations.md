...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/authentication/operations
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/authentication/operations
```
