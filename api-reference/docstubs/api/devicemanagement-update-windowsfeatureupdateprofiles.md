---
title: "Update windowsFeatureUpdateProfiles"
description: "Update the properties of a windowsFeatureUpdateProfiles object."
...
# Update windowsFeatureUpdateProfiles

Namespace: microsoft.graph

Update the properties of a windowsFeatureUpdateProfiles object.
...
-->
``` http
PATCH /deviceManagement/windowsFeatureUpdateProfiles
```
...
<!-- {
  "blockType": "request",
  "name": "update_windowsfeatureupdateprofiles"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/windowsFeatureUpdateProfiles
