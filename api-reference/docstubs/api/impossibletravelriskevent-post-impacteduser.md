...
-->
``` http
POST /impossibleTravelRiskEvents/{impossibleTravelRiskEventsId}/impactedUser/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/impossibleTravelRiskEvents/{impossibleTravelRiskEventsId}/impactedUser/$ref
