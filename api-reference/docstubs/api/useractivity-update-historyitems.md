...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/activities/{userActivityId}/historyItems
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/activities/{userActivityId}/historyItems
