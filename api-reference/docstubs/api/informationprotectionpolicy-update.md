...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/informationProtection/policy
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/informationProtection/policy
