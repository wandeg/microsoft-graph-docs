...
description: "Update the properties of a functions object."
...
Update the properties of a functions object.
...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/drive/items/{driveItemId}/workbook/functions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/drive/items/{driveItemId}/workbook/functions
...
{
  "@odata.type": "#microsoft.graph.workbookFunctions",
  "id": "d61f934c-934c-d61f-4c93-1fd64c931fd6"
}
```
