...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/drive/list/contentTypes
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/drive/list/contentTypes
```
