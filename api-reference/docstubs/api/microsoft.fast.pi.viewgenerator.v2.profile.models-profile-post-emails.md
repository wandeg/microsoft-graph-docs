...
## Request body
In the request body, supply a JSON representation for the [itemEmail](../resources/microsoft.fast.pi.viewgenerator.v2.profile.models-itememail.md) object.

The following table shows the properties that are required when you create the [itemEmail](../resources/microsoft.fast.pi.viewgenerator.v2.profile.models-itememail.md).
...
## Response
If successful, this method returns a `201 Created` response code and an [itemEmail](../resources/microsoft.fast.pi.viewgenerator.v2.profile.models-itememail.md) object in the response body.
...
{
  "@odata.type": "#Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.itemEmail",
  "id": "dd314b62-4b62-dd31-624b-31dd624b31dd",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "Microsoft.Fast.PI.ViewGenerator.V2.Profile.Models.inferenceData",
    "confidenceScore": "Double",
