...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/profile/skills/{skillProficiencyId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/skills/{skillProficiencyId}
...
{
  "@odata.type": "#microsoft.graph.skillProficiency",
  "id": "705c6d38-6d38-705c-386d-5c70386d5c70",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "microsoft.graph.inferenceData",
    "confidenceScore": "Double",
