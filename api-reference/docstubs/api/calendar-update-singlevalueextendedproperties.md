...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/calendar/singleValueExtendedProperties
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/calendar/singleValueExtendedProperties
