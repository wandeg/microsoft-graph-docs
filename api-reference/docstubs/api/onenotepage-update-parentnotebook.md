---
title: "Update parentNotebook"
description: "Update the properties of a parentNotebook object."
...
Update the properties of a parentNotebook object.
...
<!-- {
  "blockType": "request",
  "name": "update_parentnotebook"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/sites/{siteId}/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/pages/{onenotePageId}/parentNotebook
