...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/calendar/multiValueExtendedProperties/{multiValueLegacyExtendedPropertyId}
...
GET /invitations/{invitationsId}/invitedUser/calendar/events/{eventId}/multiValueExtendedProperties/{multiValueLegacyExtendedPropertyId}
...
GET /invitations/{invitationsId}/invitedUser/joinedTeams/{groupId}/conversations/{conversationId}/threads/{conversationThreadId}/posts/{postId}/multiValueExtendedProperties/{multiValueLegacyExtendedPropertyId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/calendar/multiValueExtendedProperties/{multiValueLegacyExtendedPropertyId}
```
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.multiValueLegacyExtendedProperty",
    "id": "f2197ccf-7ccf-f219-cf7c-19f2cf7c19f2",
    "value": [
      "Value value"
    ]
  }
