...
<!-- {
  "blockType": "request",
  "name": "delete_account_from_customerpaymentjournal"
}
-->
``` http
DELETE https://graph.microsoft.com/beta/financials/companies/{companyId}/customerPaymentJournals/{customerPaymentJournalId}/account
```
