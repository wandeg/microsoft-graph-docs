...
-->
``` http
PATCH /accessPackageAssignments/{accessPackageAssignmentsId}/accessPackageAssignmentResourceRoles
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/accessPackageAssignments/{accessPackageAssignmentsId}/accessPackageAssignmentResourceRoles
...
{
  "@odata.type": "#microsoft.graph.accessPackageAssignmentResourceRole",
  "id": "88e0ab46-ab46-88e0-46ab-e08846abe088",
  "originId": "Origin Id value",
  "originSystem": "Origin System value",
  "status": "Status value"
}
