...
description: "Read properties and relationships of a columnDefinition object."
...
Read properties and relationships of a [columnDefinition](../resources/columndefinition.md) object.
...
GET /invitations/{invitationsId}/invitedUser/drive/list/columns/{columnDefinitionId}
GET /invitations/{invitationsId}/invitedUser/joinedTeams/{groupId}/sites/{siteId}/columns/{columnDefinitionId}
```
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.columnDefinition",
    "id": "4897ed62-ed62-4897-62ed-974862ed9748",
    "boolean": {
