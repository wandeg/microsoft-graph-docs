...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/joinedTeams/{groupId}/planner/plans
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedTeams/{groupId}/planner/plans
```
