...
-->
``` http
GET /invitations/{invitationsId}/invitedUser/calendar/singleValueExtendedProperties
```
...
-->
``` http
GET https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/calendar/singleValueExtendedProperties
```
