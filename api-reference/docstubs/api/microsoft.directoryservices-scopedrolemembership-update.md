...
Update the properties of a [scopedRoleMembership](../resources/microsoft.directoryservices-scopedrolemembership.md) object.
...
-->
``` http
PATCH https://graph.microsoft.com/changelog/me/scopedRoleMemberOf/{scopedRoleMembershipId}
