...
Update the properties of a [group](../resources/microsoft.directoryservices-group.md) object.
...
## Request body
In the request body, supply a JSON representation for the [group](../resources/microsoft.directoryservices-group.md) object.

The following table shows the properties that are required when you create the [group](../resources/microsoft.directoryservices-group.md).
...
## Response
If successful, this method returns a `200 OK` response code and an updated [group](../resources/microsoft.directoryservices-group.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/changelog/groups/{groupsId}
