---
title: "Update timesOff"
description: "Update the properties of a timesOff object."
...
Update the properties of a timesOff object.
...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/schedule/timesOff
```
...
<!-- {
  "blockType": "request",
  "name": "update_timesoff"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedGroups/{groupId}/team/schedule/timesOff
