...
-->
``` http
PATCH /accessPackageResources/{accessPackageResourcesId}/accessPackageResourceScopes
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/accessPackageResources/{accessPackageResourcesId}/accessPackageResourceScopes
