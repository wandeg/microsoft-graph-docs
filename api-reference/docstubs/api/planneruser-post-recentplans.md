...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/planner/recentPlans/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/planner/recentPlans/$ref
