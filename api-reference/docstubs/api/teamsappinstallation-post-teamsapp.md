...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/joinedTeams/{groupId}/team/installedApps/{teamsAppInstallationId}/teamsApp/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/joinedTeams/{groupId}/team/installedApps/{teamsAppInstallationId}/teamsApp/$ref
