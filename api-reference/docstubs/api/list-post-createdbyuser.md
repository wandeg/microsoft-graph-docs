...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/drive/list/createdByUser/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/drive/list/createdByUser/$ref
