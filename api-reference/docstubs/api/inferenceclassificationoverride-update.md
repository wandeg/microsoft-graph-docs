...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/inferenceClassification/overrides/{inferenceClassificationOverrideId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/inferenceClassification/overrides/{inferenceClassificationOverrideId}
...
{
  "@odata.type": "#microsoft.graph.inferenceClassificationOverride",
  "id": "9ddde7a7-e7a7-9ddd-a7e7-dd9da7e7dd9d",
  "classifyAs": "String",
  "senderEmailAddress": {
    "@odata.type": "microsoft.graph.emailAddress",
    "name": "Name value",
