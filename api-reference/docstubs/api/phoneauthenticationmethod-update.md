...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/authentication/phoneMethods/{phoneAuthenticationMethodId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/authentication/phoneMethods/{phoneAuthenticationMethodId}
