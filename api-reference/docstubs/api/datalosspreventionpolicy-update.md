...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/informationProtection/dataLossPreventionPolicies/{dataLossPreventionPolicyId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/informationProtection/dataLossPreventionPolicies/{dataLossPreventionPolicyId}
