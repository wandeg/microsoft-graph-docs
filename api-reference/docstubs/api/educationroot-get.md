...
description: "Read properties and relationships of an educationRoot object."
...
Read properties and relationships of an [educationRoot](../resources/educationroot.md) object.
...
Content-Type: application/json
{
  "value": {
    "@odata.type": "#microsoft.graph.educationRoot",
    "id": "def56cc8-6cc8-def5-c86c-f5dec86cf5de"
  }
}
```
