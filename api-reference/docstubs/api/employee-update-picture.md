...
-->
``` http
PATCH /financials/companies/{companyId}/employees/{employeeId}/picture
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/employees/{employeeId}/picture
