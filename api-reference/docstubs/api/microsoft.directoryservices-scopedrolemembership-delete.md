...
Deletes a [scopedRoleMembership](../resources/microsoft.directoryservices-scopedrolemembership.md).
...
-->
``` http
DELETE https://graph.microsoft.com/changelog/me/scopedRoleMemberOf/{scopedRoleMembershipId}
```
