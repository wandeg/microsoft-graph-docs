...
-->
``` http
POST /identityRiskEvents/{identityRiskEventsId}/impactedUser/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/identityRiskEvents/{identityRiskEventsId}/impactedUser/$ref
