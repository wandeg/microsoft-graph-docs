...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/profile/emails/{itemEmailId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/profile/emails/{itemEmailId}
