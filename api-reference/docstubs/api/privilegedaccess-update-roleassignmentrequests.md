...
-->
``` http
PATCH /privilegedAccess/{privilegedAccessId}/roleAssignmentRequests
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/privilegedAccess/{privilegedAccessId}/roleAssignmentRequests
