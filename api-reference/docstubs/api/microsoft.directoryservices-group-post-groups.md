...
Create a new [group](../resources/microsoft.directoryservices-group.md) object.
...
## Response
If successful, this method returns a `201 Created` response code and a [group](../resources/microsoft.directoryservices-group.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/changelog/groups
