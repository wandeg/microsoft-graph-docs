...
-->
``` http
PATCH /invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/childFolders
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/mailFolders/{mailFolderId}/childFolders
...
{
  "@odata.type": "#microsoft.graph.mailFolder",
  "id": "a2dc5aa4-5aa4-a2dc-a45a-dca2a45adca2",
  "displayName": "Display Name value",
  "parentFolderId": "Parent Folder Id value",
  "childFolderCount": 0,
  "unreadItemCount": 15,
