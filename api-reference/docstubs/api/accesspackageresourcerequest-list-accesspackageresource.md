...
-->
``` http
GET /accessPackageResourceRequests/{accessPackageResourceRequestsId}/accessPackageResource
```
...
-->
``` http
GET https://graph.microsoft.com/beta/accessPackageResourceRequests/{accessPackageResourceRequestsId}/accessPackageResource
```
