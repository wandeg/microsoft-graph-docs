...
-->
``` http
POST /invitations/{invitationsId}/invitedUser/messages/{messageId}/event/multiValueExtendedProperties
```
...
-->
``` http
POST https://graph.microsoft.com/beta/invitations/{invitationsId}/invitedUser/messages/{messageId}/event/multiValueExtendedProperties
