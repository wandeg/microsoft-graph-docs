...
-->
``` http
PATCH /teams/{teamsId}/schedule/offerShiftRequests
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/teams/{teamsId}/schedule/offerShiftRequests
...
{
  "@odata.type": "#microsoft.graph.offerShiftRequest",
  "id": "42ae18e2-18e2-42ae-e218-ae42e218ae42",
