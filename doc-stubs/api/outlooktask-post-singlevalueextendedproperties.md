...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/outlook/taskGroups/{outlookTaskGroupId}/taskFolders/{outlookTaskFolderId}/tasks/{outlookTaskId}/singleValueExtendedProperties
...
{
  "@odata.type": "#microsoft.graph.singleValueLegacyExtendedProperty",
  "id": "a325c2b1-c2b1-a325-b1c2-25a3b1c225a3",
  "value": "String"
}
```
