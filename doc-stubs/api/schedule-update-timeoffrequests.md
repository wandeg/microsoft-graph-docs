...
-->
``` http
PATCH /teams/{teamsId}/schedule/timeOffRequests
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/teams/{teamsId}/schedule/timeOffRequests
...
{
  "@odata.type": "#microsoft.graph.timeOffRequest",
  "id": "1b2706a9-06a9-1b27-a906-271ba906271b",
