...
description: "Create a new controls object."
...
-->
``` http
POST ** Collection URI for microsoft.graph.programControl not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.programControl not found
...
{
  "@odata.type": "#microsoft.graph.programControl",
  "id": "dd5b696b-696b-dd5b-6b69-5bdd6b695bdd",
  "controlId": "String",
  "programId": "String",
  "controlTypeId": "String",
  "displayName": "String",
