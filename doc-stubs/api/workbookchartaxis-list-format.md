...
-->
``` http
GET https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/format
```
  ...
  "value": [
    {
      ...
      "id": "79e47e05-7e05-79e4-057e-e479057ee479"
    }
  ]
}
```
