...
<!-- {
  "blockType": "request",
  "name": "delete_account_from_salesinvoiceline"
}
-->
``` http
DELETE https://graph.microsoft.com/beta/financials/companies/{companyId}/salesInvoices/{salesInvoiceId}/salesInvoiceLines/{salesInvoiceLineId}/account
```
