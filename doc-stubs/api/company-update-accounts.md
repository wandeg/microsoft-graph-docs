...
description: "Update the properties of an accounts object."
...
Update the properties of an accounts object.
...
-->
``` http
PATCH /financials/companies/{companyId}/accounts
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/accounts
