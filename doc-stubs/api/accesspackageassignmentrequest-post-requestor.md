...
-->
``` http
POST /accessPackageAssignmentRequests/{accessPackageAssignmentRequestsId}/requestor
```
...
-->
``` http
POST https://graph.microsoft.com/beta/accessPackageAssignmentRequests/{accessPackageAssignmentRequestsId}/requestor
