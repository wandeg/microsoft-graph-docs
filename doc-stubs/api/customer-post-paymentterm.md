...
-->
``` http
POST /financials/companies/{companyId}/customers/{customerId}/paymentTerm
```
...
-->
``` http
POST https://graph.microsoft.com/beta/financials/companies/{companyId}/customers/{customerId}/paymentTerm
