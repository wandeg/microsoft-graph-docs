...
-->
``` http
PATCH /workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/pivotTables/{workbookPivotTableId}/worksheet
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/pivotTables/{workbookPivotTableId}/worksheet
...
{
  "@odata.type": "#microsoft.graph.workbookWorksheet",
  "id": "86cfffb9-ffb9-86cf-b9ff-cf86b9ffcf86",
  "name": "String",
  "position": "Integer",
  "visibility": "String"
}
