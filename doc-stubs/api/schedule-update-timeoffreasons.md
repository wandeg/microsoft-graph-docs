...
-->
``` http
PATCH /teams/{teamsId}/schedule/timeOffReasons
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/teams/{teamsId}/schedule/timeOffReasons
...
{
  "@odata.type": "#microsoft.graph.timeOffReason",
  "id": "ed904a0a-4a0a-ed90-0a4a-90ed0a4a90ed",
