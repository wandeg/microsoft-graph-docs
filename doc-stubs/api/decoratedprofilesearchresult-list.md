...
description: "Get a list of the DecoratedProfileSearchResult objects and their properties."
...
Get a list of the [DecoratedProfileSearchResult](../resources/decoratedprofilesearchresult.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/decoratedProfileSearchResults
```
