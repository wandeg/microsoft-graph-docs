...
-->
``` http
GET /workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/analytics/itemActivityStats/{itemActivityStatId}/activities
```
...
-->
``` http
GET https://graph.microsoft.com/beta/workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/analytics/itemActivityStats/{itemActivityStatId}/activities
```
