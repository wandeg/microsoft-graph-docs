...
-->
``` http
GET /users/{usersId}/planner/plans/{plannerPlanId}/buckets/{plannerBucketId}/tasks
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/users/{usersId}/planner/plans/{plannerPlanId}/buckets/{plannerBucketId}/tasks
```
