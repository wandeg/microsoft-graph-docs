...
-->
``` http
PATCH /organization/{organizationId}/branding/{organizationalBrandingId}/localizations
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/organization/{organizationId}/branding/{organizationalBrandingId}/localizations
...
{
  "@odata.type": "#microsoft.graph.organizationalBrandingLocalization",
  "id": "259a3492-3492-259a-9234-9a2592349a25",
  "backgroundColor": "String",
  "backgroundImage": "Stream",
  "bannerLogo": "Stream",
  "signInPageText": "String",
