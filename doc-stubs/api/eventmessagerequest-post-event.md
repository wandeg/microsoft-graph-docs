...
-->
``` http
POST /users/{usersId}/messages/{messageId}/event
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/users/{usersId}/messages/{messageId}/event
...
{
  "@odata.type": "#microsoft.graph.event",
  "id": "3fc7c3c1-c3c1-3fc7-c1c3-c73fc1c3c73f",
