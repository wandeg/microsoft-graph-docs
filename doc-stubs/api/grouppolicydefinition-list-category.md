---
title: "List category"
description: "Get the groupPolicyCategories from the category navigation property."
...
Get the groupPolicyCategories from the category navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagement/groupPolicyConfigurations/{groupPolicyConfigurationId}/definitionValues/{groupPolicyDefinitionValueId}/presentationValues/{groupPolicyPresentationValueId}/presentation/definition/category
```
