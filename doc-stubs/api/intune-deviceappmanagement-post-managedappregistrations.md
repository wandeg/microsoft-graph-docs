...
If successful, this method returns a `201 Created` response code and a [managedAppRegistration](../resources/intune-managedappregistration.md) object in the response body.
