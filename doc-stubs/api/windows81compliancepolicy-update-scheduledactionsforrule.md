...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicyId}/scheduledActionsForRule
...
{
  "@odata.type": "#microsoft.graph.deviceComplianceScheduledActionForRule",
  "id": "65c8faac-faac-65c8-acfa-c865acfac865",
  "ruleName": "String"
}
```
