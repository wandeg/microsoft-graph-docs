...
-->
``` http
PATCH /cases/{casesId}/reviewSets/{reviewSetId}/queries/{reviewSetQueryId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/cases/{casesId}/reviewSets/{reviewSetId}/queries/{reviewSetQueryId}
...
{
  "@odata.type": "#microsoft.graph.reviewSetQuery",
  "id": "e96f40e0-40e0-e96f-e040-6fe9e0406fe9",
  "query": "String",
