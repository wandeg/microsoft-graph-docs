...
If successful, this method returns a `204 No Content` response code and a [managedDevice](../resources/intune-manageddevice.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/detectedApps/{detectedAppId}/managedDevices/$ref
...
{
  "@odata.type": "#microsoft.graph.managedDevice",
  "id": "f3a7f54f-f54f-f3a7-4ff5-a7f34ff5a7f3",
  "userId": "String",
  "deviceName": "String",
  "managedDeviceOwnerType": "String",
  "deviceActionResults": [
