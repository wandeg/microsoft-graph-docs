---
title: "List currency"
description: "Get the currencies from the currency navigation property."
...
Get the currencies from the currency navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/financials/companies/{companyId}/customers/{customerId}/currency
```
