...
-->
``` http
GET ** Collection URI for microsoft.graph.oAuth2PermissionGrant not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.oAuth2PermissionGrant not found
```
