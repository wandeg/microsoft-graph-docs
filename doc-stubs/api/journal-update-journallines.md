...
-->
``` http
PATCH /financials/companies/{companyId}/journals/{journalId}/journalLines
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/journals/{journalId}/journalLines
