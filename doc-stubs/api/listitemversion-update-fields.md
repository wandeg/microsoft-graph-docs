...
-->
``` http
PATCH /workbooks/{workbooksId}/listItem/versions/{listItemVersionId}/fields
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/listItem/versions/{listItemVersionId}/fields
...
{
  "@odata.type": "#microsoft.graph.fieldValueSet",
  "id": "55bfad74-ad74-55bf-74ad-bf5574adbf55"
}
```
