...
-->
``` http
POST https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/legend
...
{
  "@odata.type": "#microsoft.graph.workbookChartLegend",
  "id": "e60d7367-7367-e60d-6773-0de667730de6",
  "overlay": "Boolean",
  "position": "String",
  "visible": "Boolean"
}
