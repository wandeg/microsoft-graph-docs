...
-->
``` http
POST ** Collection URI for microsoft.graph.accessPackageCatalog not found/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.accessPackageCatalog not found/$ref
...
{
  "@odata.type": "#microsoft.graph.accessPackageCatalog",
  "id": "ddf9ceca-ceca-ddf9-cace-f9ddcacef9dd",
  "displayName": "String",
  "description": "String",
  "catalogType": "String",
  "catalogStatus": "String",
