...
description: "Update the properties of a manufacturerRegression object."
...
Update the properties of a manufacturerRegression object.
...
-->
``` http
PATCH /deviceManagement/userExperienceAnalyticsRegressionSummary/manufacturerRegression
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/userExperienceAnalyticsRegressionSummary/manufacturerRegression
