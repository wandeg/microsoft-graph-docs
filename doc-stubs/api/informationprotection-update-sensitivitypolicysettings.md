...
-->
``` http
PATCH /users/{usersId}/informationProtection/sensitivityPolicySettings
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/informationProtection/sensitivityPolicySettings
