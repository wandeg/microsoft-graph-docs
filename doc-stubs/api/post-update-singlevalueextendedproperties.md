...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/groups/{groupsId}/conversations/{conversationId}/threads/{conversationThreadId}/posts/{postId}/singleValueExtendedProperties
...
{
  "@odata.type": "#microsoft.graph.singleValueLegacyExtendedProperty",
  "id": "d8686d1d-6d1d-d868-1d6d-68d81d6d68d8",
  "value": "String"
}
```
