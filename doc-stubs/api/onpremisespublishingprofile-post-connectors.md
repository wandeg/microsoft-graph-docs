...
description: "Create a new connectors object."
...
Create a new connectors object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.connector not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.connector not found
