---
title: "Update featureRolloutPolicies"
description: "Update the properties of a featureRolloutPolicies object."
...
# Update featureRolloutPolicies

Namespace: microsoft.graph

Update the properties of a featureRolloutPolicies object.
...
-->
``` http
PATCH /directory/featureRolloutPolicies
```
...
<!-- {
  "blockType": "request",
  "name": "update_featurerolloutpolicies"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/directory/featureRolloutPolicies
