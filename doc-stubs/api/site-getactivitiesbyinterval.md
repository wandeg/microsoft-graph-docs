...
-->
``` http
GET https://graph.microsoft.com/v1.0/sites/{sitesId}/getActivitiesByInterval(startDateTime='parameterValue',endDateTime='parameterValue',interval='parameterValue')
```
