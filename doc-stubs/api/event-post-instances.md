...
-->
``` http
POST /users/{usersId}/messages/{messageId}/event/instances
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/event/instances
...
{
  "@odata.type": "#microsoft.graph.event",
  "id": "b2c50e3d-0e3d-b2c5-3d0e-c5b23d0ec5b2",
