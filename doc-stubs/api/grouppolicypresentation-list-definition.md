...
description: "Get the groupPolicyDefinitions from the definition navigation property."
...
Get the groupPolicyDefinitions from the definition navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagement/groupPolicyConfigurations/{groupPolicyConfigurationId}/definitionValues/{groupPolicyDefinitionValueId}/presentationValues/{groupPolicyPresentationValueId}/presentation/definition
```
