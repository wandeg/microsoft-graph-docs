...
-->
``` http
PATCH /users/{usersId}/informationProtection/sensitivityLabels/{sensitivityLabelId}/sublabels
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/informationProtection/sensitivityLabels/{sensitivityLabelId}/sublabels
