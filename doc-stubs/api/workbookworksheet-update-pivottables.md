...
-->
``` http
PATCH /workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/pivotTables
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/pivotTables
...
{
  "@odata.type": "#microsoft.graph.workbookPivotTable",
  "id": "663aae9b-ae9b-663a-9bae-3a669bae3a66",
  "name": "String"
}
```
