...
-->
``` http
PATCH /users/{usersId}/onenote/notebooks/{notebookId}/sectionGroups
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/users/{usersId}/onenote/notebooks/{notebookId}/sectionGroups
