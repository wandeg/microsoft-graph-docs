...
-->
``` http
POST ** Collection URI for microsoft.compliance.ediscovery.contract.ediscoveryCase not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.compliance.ediscovery.contract.ediscoveryCase not found
...
Content-Type: application/json
{
  ...
  "closedDateTime": "String (timestamp)",
  "externalId": "String",
  "id": "6c8722eb-22eb-6c87-eb22-876ceb22876c",
  "displayName": "String",
