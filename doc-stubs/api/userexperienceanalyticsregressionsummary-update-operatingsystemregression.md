...
description: "Update the properties of an operatingSystemRegression object."
...
Update the properties of an operatingSystemRegression object.
...
-->
``` http
PATCH /deviceManagement/userExperienceAnalyticsRegressionSummary/operatingSystemRegression
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/userExperienceAnalyticsRegressionSummary/operatingSystemRegression
