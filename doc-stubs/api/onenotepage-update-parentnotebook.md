...
-->
``` http
PATCH /users/{usersId}/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/pages/{onenotePageId}/parentNotebook
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/users/{usersId}/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/pages/{onenotePageId}/parentNotebook
...
{
  "@odata.type": "#microsoft.graph.notebook",
  "id": "e56c8750-8750-e56c-5087-6ce550876ce5",
  "self": "String",
