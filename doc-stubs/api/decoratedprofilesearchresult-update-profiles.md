...
description: "Update the properties of a profiles object."
...
Update the properties of a profiles object.
...
-->
``` http
PATCH /decoratedProfileSearchResults/{decoratedProfileSearchResultsId}/profiles
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/decoratedProfileSearchResults/{decoratedProfileSearchResultsId}/profiles
