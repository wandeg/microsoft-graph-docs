...
-->
``` http
POST /users/{usersId}/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/pages
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/users/{usersId}/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/pages
...
{
  "@odata.type": "#microsoft.graph.onenotePage",
  "id": "42962314-2314-4296-1423-964214239642",
  "self": "String",
