...
description: "Update the properties of a countriesRegions object."
...
-->
``` http
PATCH /financials/companies/{companyId}/countriesRegions
```
...
<!-- {
  "blockType": "request",
  "name": "update_countriesregions"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/countriesRegions
...
{
  "@odata.type": "#microsoft.graph.countryRegion",
  "id": "561e611a-611a-561e-1a61-1e561a611e56",
  "code": "String",
  "displayName": "String",
  "addressFormat": "String",
