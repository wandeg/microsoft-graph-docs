...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicyId}/deviceStatuses
...
{
  "@odata.type": "#microsoft.graph.deviceComplianceDeviceStatus",
  "id": "99ffbbd0-bbd0-99ff-d0bb-ff99d0bbff99",
  "deviceDisplayName": "String",
  "userName": "String",
  "deviceModel": "String",
  "complianceGracePeriodExpirationDateTime": "String (timestamp)",
