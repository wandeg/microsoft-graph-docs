---
title: "featureFlightedConfiguration: assign"
...
-->
``` http
POST ** Entity URI for microsoft.graph.featureFlightedConfiguration not found/assign
```
...
<!-- {
  "blockType": "request",
  "name": "featureflightedconfiguration_assign"
}
-->
``` http
POST https://graph.microsoft.com/beta** Entity URI for microsoft.graph.featureFlightedConfiguration not found/assign
