...
-->
``` http
GET /users/{usersId}/teamwork/installedApps/{teamsAppInstallationId}/teamsApp
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/teamwork/installedApps/{teamsAppInstallationId}/teamsApp
```
