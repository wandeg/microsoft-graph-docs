...
-->
``` http
GET /teams/{teamsId}/installedApps/{teamsAppInstallationId}/teamsApp
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/teams/{teamsId}/installedApps/{teamsAppInstallationId}/teamsApp
```
