...
-->
``` http
PATCH /deviceManagement/userExperienceAnalyticsDeviceStartupHistory
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/userExperienceAnalyticsDeviceStartupHistory
