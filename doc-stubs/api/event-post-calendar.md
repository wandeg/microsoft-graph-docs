...
-->
``` http
POST /users/{usersId}/messages/{messageId}/event/calendar
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/event/calendar
...
{
  "@odata.type": "#microsoft.graph.calendar",
  "id": "244e917a-917a-244e-7a91-4e247a914e24",
  "name": "String",
  "color": "String",
  "hexColor": "String",
  "isDefaultCalendar": "Boolean",
