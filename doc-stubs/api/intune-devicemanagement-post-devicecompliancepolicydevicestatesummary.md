...
If successful, this method returns a `201 Created` response code and a [deviceCompliancePolicyDeviceStateSummary](../resources/intune-devicecompliancepolicydevicestatesummary.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/deviceManagement/deviceCompliancePolicyDeviceStateSummary
...
{
  "@odata.type": "#microsoft.graph.deviceCompliancePolicyDeviceStateSummary",
  "id": "92dfde31-de31-92df-31de-df9231dedf92",
  "inGracePeriodCount": "Integer",
  "configManagerCount": "Integer",
  "unknownDeviceCount": "Integer",
  "notApplicableDeviceCount": "Integer",
