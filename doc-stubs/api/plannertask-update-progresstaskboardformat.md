...
-->
``` http
PATCH /users/{usersId}/planner/tasks/{plannerTaskId}/progressTaskBoardFormat
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/planner/tasks/{plannerTaskId}/progressTaskBoardFormat
...
{
  "@odata.type": "#microsoft.graph.plannerProgressTaskBoardTaskFormat",
  "id": "44d8b610-b610-44d8-10b6-d84410b6d844",
  "orderHint": "String"
}
```
