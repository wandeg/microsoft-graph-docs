---
title: "Update wdacSupplementalPolicies"
description: "Update the properties of a wdacSupplementalPolicies object."
...
# Update wdacSupplementalPolicies

Namespace: microsoft.graph

Update the properties of a wdacSupplementalPolicies object.
...
-->
``` http
PATCH /deviceAppManagement/wdacSupplementalPolicies
```
...
<!-- {
  "blockType": "request",
  "name": "update_wdacsupplementalpolicies"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceAppManagement/wdacSupplementalPolicies
