...
-->
``` http
GET https://graph.microsoft.com/beta/print/reports/getUserPrintUsageSummary(userId='parameterValue',periodStart=String (timestamp),periodEnd=String (timestamp))
```
