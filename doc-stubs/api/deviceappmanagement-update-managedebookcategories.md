...
description: "Update the properties of a managedEBookCategories object."
...
Update the properties of a managedEBookCategories object.
...
-->
``` http
PATCH /deviceAppManagement/managedEBookCategories
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceAppManagement/managedEBookCategories
...
{
  "@odata.type": "#microsoft.graph.managedEBookCategory",
  "id": "badb60a1-60a1-badb-a160-dbbaa160dbba",
  "displayName": "String",
