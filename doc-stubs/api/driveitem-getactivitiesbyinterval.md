...
-->
``` http
GET https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/getActivitiesByInterval(startDateTime='parameterValue',endDateTime='parameterValue',interval='parameterValue')
```
