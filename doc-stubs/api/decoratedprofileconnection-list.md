...
description: "Get a list of the DecoratedProfileConnection objects and their properties."
...
Get a list of the [DecoratedProfileConnection](../resources/decoratedprofileconnection.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/decoratedProfileConnections
```
