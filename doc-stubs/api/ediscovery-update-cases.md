...
-->
``` http
PATCH ** Collection URI for microsoft.graph.ediscoveryCase not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.graph.ediscoveryCase not found
...
{
  "@odata.type": "#microsoft.graph.ediscoveryCase",
  "id": "79850a60-0a60-7985-600a-8579600a8579",
  "description": "String",
  "createdBy": "String",
