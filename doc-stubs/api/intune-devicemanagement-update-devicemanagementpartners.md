---
title: "Update deviceManagementPartners"
description: "Update the properties of a deviceManagementPartners object."
...
# Update deviceManagementPartners

Namespace: microsoft.graph

Update the properties of a deviceManagementPartners object.
...
-->
``` http
PATCH /deviceManagement/deviceManagementPartners
```
...
If successful, this method returns a `200 OK` response code and an updated [deviceManagementPartner](../resources/intune-devicemanagementpartner.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "update_devicemanagementpartners"
}
-->
``` http
PATCH https://graph.microsoft.com/v1.0/deviceManagement/deviceManagementPartners
...
{
  "@odata.type": "#microsoft.graph.deviceManagementPartner",
  "id": "c3068812-8812-c306-1288-06c3128806c3",
  "lastHeartbeatDateTime": "String (timestamp)",
  "partnerState": "String",
  "partnerAppType": "String",
  "singleTenantAppId": "String",
