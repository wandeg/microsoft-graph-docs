---
title: "Update exchangeOnPremisesPolicies"
description: "Update the properties of an exchangeOnPremisesPolicies object."
...
# Update exchangeOnPremisesPolicies

Namespace: microsoft.graph

Update the properties of an exchangeOnPremisesPolicies object.
...
-->
``` http
PATCH /deviceManagement/exchangeOnPremisesPolicies
```
...
<!-- {
  "blockType": "request",
  "name": "update_exchangeonpremisespolicies"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/exchangeOnPremisesPolicies
