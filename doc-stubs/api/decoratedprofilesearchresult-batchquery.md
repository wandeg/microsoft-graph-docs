---
title: "DecoratedProfileSearchResult: batchQuery"
...
|:---|:---|:---|
|queries|[DecoratedProfileSearchQuery](../resources/decoratedprofilesearchquery.md) collection|**TODO: Add Description**|
...
-->
``` http
GET https://graph.microsoft.com/v1.0/decoratedProfileSearchResults/batchQuery(queries=[
  {
