...
If successful, this method returns a `201 Created` response code and a [termsAndConditions](../resources/intune-termsandconditions.md) object in the response body.
