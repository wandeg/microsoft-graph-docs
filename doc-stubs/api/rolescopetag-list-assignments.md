...
-->
``` http
GET /deviceManagement/roleScopeTags/{roleScopeTagId}/assignments
```
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagement/roleScopeTags/{roleScopeTagId}/assignments
```
