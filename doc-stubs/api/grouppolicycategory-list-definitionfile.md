---
title: "List definitionFile"
description: "Get the groupPolicyDefinitionFiles from the definitionFile navigation property."
...
Get the groupPolicyDefinitionFiles from the definitionFile navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/deviceManagement/groupPolicyConfigurations/{groupPolicyConfigurationId}/definitionValues/{groupPolicyDefinitionValueId}/presentationValues/{groupPolicyPresentationValueId}/presentation/definition/category/definitionFile
```
