...
-->
``` http
PATCH /workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/names
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/names
...
{
  "@odata.type": "#microsoft.graph.workbookNamedItem",
  "id": "2d798236-8236-2d79-3682-792d3682792d",
  "comment": "String",
  "name": "String",
  "scope": "String",
  "type": "String",
