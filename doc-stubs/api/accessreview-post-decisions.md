...
description: "Create a new decisions object."
...
-->
``` http
POST ** Collection URI for microsoft.graph.accessReviewDecision not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.accessReviewDecision not found
