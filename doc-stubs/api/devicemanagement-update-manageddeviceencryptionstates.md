---
title: "Update managedDeviceEncryptionStates"
description: "Update the properties of a managedDeviceEncryptionStates object."
...
# Update managedDeviceEncryptionStates

Namespace: microsoft.graph

Update the properties of a managedDeviceEncryptionStates object.
...
-->
``` http
PATCH /deviceManagement/managedDeviceEncryptionStates
```
...
<!-- {
  "blockType": "request",
  "name": "update_manageddeviceencryptionstates"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/managedDeviceEncryptionStates
