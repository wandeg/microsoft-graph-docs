...
-->
``` http
PATCH ** Collection URI for microsoft.graph.domainDnsRecord not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.graph.domainDnsRecord not found
...
{
  "@odata.type": "#microsoft.graph.domainDnsRecord",
  "id": "07ec645f-645f-07ec-5f64-ec075f64ec07",
  "isOptional": "Boolean",
  "label": "String",
  "recordType": "String",
  "supportedService": "String",
