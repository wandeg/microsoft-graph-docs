...
-->
``` http
PATCH /onPremisesPublishingProfiles/{onPremisesPublishingProfilesId}/connectorGroups
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/onPremisesPublishingProfiles/{onPremisesPublishingProfilesId}/connectorGroups
