...
description: "Update the properties of an evaluateDlpPoliciesJobs object."
...
Update the properties of an evaluateDlpPoliciesJobs object.
...
-->
``` http
PATCH /dataClassification/evaluateDlpPoliciesJobs
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/dataClassification/evaluateDlpPoliciesJobs
