...
If successful, this method returns a `200 OK` response code and an updated [mobileApp](../resources/intune-mobileapp.md) object in the response body.
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/deviceAppManagement/mobileApps
...
{
  "@odata.type": "#microsoft.graph.mobileApp",
  "id": "b526d5c5-d5c5-b526-c5d5-26b5c5d526b5",
  "displayName": "String",
  "description": "String",
  "publisher": "String",
  "largeIcon": {
