...
description: "Update the properties of a subject object."
...
Update the properties of a subject object.
...
-->
``` http
PATCH ** Collection URI for microsoft.graph.governanceSubject not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.graph.governanceSubject not found
