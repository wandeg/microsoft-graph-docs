...
-->
``` http
POST /users/{usersId}/planner/plans/{plannerPlanId}/buckets/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/users/{usersId}/planner/plans/{plannerPlanId}/buckets/$ref
...
{
  "@odata.type": "#microsoft.graph.plannerBucket",
  "id": "2485ed0f-ed0f-2485-0fed-85240fed8524",
  "name": "String",
  "planId": "String",
  "orderHint": "String"
}
