...
-->
``` http
GET /organization/{organizationId}/branding/{organizationalBrandingId}/localizations/{organizationalBrandingLocalizationId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/organization/{organizationId}/branding/{organizationalBrandingId}/localizations/{organizationalBrandingLocalizationId}
```
