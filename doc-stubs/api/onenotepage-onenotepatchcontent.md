...
POST /users/{usersId}/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/pages/{onenotePageId}/onenotePatchContent
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePageId}/onenotePatchContent
