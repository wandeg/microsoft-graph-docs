...
-->
``` http
PATCH ** Collection URI for microsoft.graph.user not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.graph.user not found
...
{
  "@odata.type": "#microsoft.graph.user",
  "id": "468e4869-4869-468e-6948-8e4669488e46",
  "deletedDateTime": "String (timestamp)",
  "signInActivity": {
    "@odata.type": "microsoft.graph.signInActivity"
  },
