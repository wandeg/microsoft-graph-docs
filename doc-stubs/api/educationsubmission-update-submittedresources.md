---
title: "Update submittedResources"
description: "Update the properties of a submittedResources object."
...
# Update submittedResources

Namespace: microsoft.graph

Update the properties of a submittedResources object.
...
-->
``` http
PATCH /education/classes/{educationClassId}/assignments/{educationAssignmentId}/submissions/{educationSubmissionId}/submittedResources
```
...
<!-- {
  "blockType": "request",
  "name": "update_submittedresources"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/education/classes/{educationClassId}/assignments/{educationAssignmentId}/submissions/{educationSubmissionId}/submittedResources
