...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/deviceManagement/deviceConfigurations/{deviceConfigurationId}/deviceStatuses
...
{
  "@odata.type": "#microsoft.graph.deviceConfigurationDeviceStatus",
  "id": "6c29e7d8-e7d8-6c29-d8e7-296cd8e7296c",
  "deviceDisplayName": "String",
  "userName": "String",
  "deviceModel": "String",
  "complianceGracePeriodExpirationDateTime": "String (timestamp)",
