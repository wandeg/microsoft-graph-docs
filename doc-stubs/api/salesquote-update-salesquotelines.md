...
-->
``` http
PATCH /financials/companies/{companyId}/salesQuotes/{salesQuoteId}/salesQuoteLines
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/salesQuotes/{salesQuoteId}/salesQuoteLines
