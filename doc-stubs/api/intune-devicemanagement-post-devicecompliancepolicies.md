...
If successful, this method returns a `201 Created` response code and a [deviceCompliancePolicy](../resources/intune-devicecompliancepolicy.md) object in the response body.
