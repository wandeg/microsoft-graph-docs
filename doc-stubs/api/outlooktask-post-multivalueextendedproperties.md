...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/outlook/taskGroups/{outlookTaskGroupId}/taskFolders/{outlookTaskFolderId}/tasks/{outlookTaskId}/multiValueExtendedProperties
...
{
  "@odata.type": "#microsoft.graph.multiValueLegacyExtendedProperty",
  "id": "7aa22563-2563-7aa2-6325-a27a6325a27a",
  "value": [
    "String"
  ]
}
