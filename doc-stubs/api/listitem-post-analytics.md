...
-->
``` http
POST /workbooks/{workbooksId}/listItem/analytics/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/listItem/analytics/$ref
...
{
  "@odata.type": "#microsoft.graph.itemAnalytics",
  "id": "581b3fe9-3fe9-581b-e93f-1b58e93f1b58"
}
```
