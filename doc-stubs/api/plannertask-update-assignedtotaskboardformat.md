...
-->
``` http
PATCH /users/{usersId}/planner/tasks/{plannerTaskId}/assignedToTaskBoardFormat
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/users/{usersId}/planner/tasks/{plannerTaskId}/assignedToTaskBoardFormat
...
{
  "@odata.type": "#microsoft.graph.plannerAssignedToTaskBoardTaskFormat",
  "id": "5eaf8e73-8e73-5eaf-738e-af5e738eaf5e",
  "unassignedOrderHint": "String",
  "orderHintsByAssignee": {
    "@odata.type": "microsoft.graph.plannerOrderHintsByAssignee"
  }
