...
description: "Create a new contentVersions object."
...
Create a new contentVersions object.
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.graph.mobileAppContent not found
...
{
  "@odata.type": "#microsoft.graph.mobileAppContent",
  "id": "642c6dbd-6dbd-642c-bd6d-2c64bd6d2c64"
}
```
