...
-->
``` http
PATCH /onPremisesPublishingProfiles/{onPremisesPublishingProfilesId}/connectors
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/onPremisesPublishingProfiles/{onPremisesPublishingProfilesId}/connectors
