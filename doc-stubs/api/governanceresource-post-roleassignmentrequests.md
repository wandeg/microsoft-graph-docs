---
title: "Create roleAssignmentRequests"
description: "Create a new roleAssignmentRequests object."
...
# Create roleAssignmentRequests

Namespace: microsoft.graph

Create a new roleAssignmentRequests object.
...
-->
``` http
POST ** Collection URI for microsoft.graph.governanceRoleAssignmentRequest not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.governanceRoleAssignmentRequest not found
