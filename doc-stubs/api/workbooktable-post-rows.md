...
-->
``` http
POST https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/tables/{workbookTableId}/rows
...
{
  "@odata.type": "#microsoft.graph.workbookTableRow",
  "id": "64efd488-d488-64ef-88d4-ef6488d4ef64",
  "index": "Integer",
  "values": {
    "@odata.type": "microsoft.graph.Json"
  }
