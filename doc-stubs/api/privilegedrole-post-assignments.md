...
-->
``` http
POST ** Collection URI for microsoft.graph.privilegedRoleAssignment not found/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.privilegedRoleAssignment not found/$ref
