...
description: "Update the properties of a classifyFileJobs object."
...
Update the properties of a classifyFileJobs object.
...
-->
``` http
PATCH /dataClassification/classifyFileJobs
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/dataClassification/classifyFileJobs
