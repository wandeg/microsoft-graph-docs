...
-->
``` http
POST /policyRoot/claimsMappingPolicies/{claimsMappingPolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/policyRoot/claimsMappingPolicies/{claimsMappingPolicyId}/appliesTo/$ref
