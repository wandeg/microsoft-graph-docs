...
<!-- {
  "blockType": "request",
  "name": "delete_account_from_generalledgerentry"
}
-->
``` http
DELETE https://graph.microsoft.com/beta/financials/companies/{companyId}/generalLedgerEntries/{generalLedgerEntryId}/account
```
