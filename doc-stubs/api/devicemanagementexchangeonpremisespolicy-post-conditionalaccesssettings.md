...
-->
``` http
POST /deviceManagement/exchangeOnPremisesPolicy/conditionalAccessSettings
```
...
-->
``` http
POST https://graph.microsoft.com/beta/deviceManagement/exchangeOnPremisesPolicy/conditionalAccessSettings
...
{
  "@odata.type": "#microsoft.graph.onPremisesConditionalAccessSettings",
  "id": "773de86f-e86f-773d-6fe8-3d776fe83d77",
  "enabled": "Boolean",
  "includedGroups": [
    "Guid"
  ],
