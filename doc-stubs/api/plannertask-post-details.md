...
-->
``` http
POST /users/{usersId}/planner/tasks/{plannerTaskId}/details
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/planner/tasks/{plannerTaskId}/details
...
{
  "@odata.type": "#microsoft.graph.plannerTaskDetails",
  "id": "bd9e328d-328d-bd9e-8d32-9ebd8d329ebd",
  "description": "String",
  "previewType": "String",
  "references": {
    "@odata.type": "microsoft.graph.plannerExternalReferences"
