...
-->
``` http
PATCH /workbooks/{workbooksId}/analytics/itemActivityStats/{itemActivityStatId}/activities/{itemActivityId}/driveItem
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/analytics/itemActivityStats/{itemActivityStatId}/activities/{itemActivityId}/driveItem
