...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/majorGridlines/format/line
...
{
  "@odata.type": "#microsoft.graph.workbookChartLineFormat",
  "id": "76f9b270-b270-76f9-70b2-f97670b2f976",
  "color": "String"
}
```
