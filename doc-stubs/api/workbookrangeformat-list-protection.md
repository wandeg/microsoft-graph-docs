...
description: "Get the workbookFormatProtections from the protection navigation property."
...
Get the workbookFormatProtections from the protection navigation property.
...
-->
``` http
GET https://graph.microsoft.com/v1.0/workbookRange/format/protection
```
