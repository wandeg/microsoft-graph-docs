---
title: "List managedDevices2"
description: "Get the managedDevices from the managedDevices2 navigation property."
...
# List managedDevices2

Namespace: microsoft.graph

Get the managedDevices from the managedDevices2 navigation property.
...
-->
``` http
GET /users/{usersId}/managedDevices2
```
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/managedDevices2
```
