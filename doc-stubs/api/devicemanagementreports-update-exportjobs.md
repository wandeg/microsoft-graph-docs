---
title: "Update exportJobs"
description: "Update the properties of an exportJobs object."
...
Update the properties of an exportJobs object.
...
-->
``` http
PATCH /deviceManagement/reports/exportJobs
```
...
<!-- {
  "blockType": "request",
  "name": "update_exportjobs"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/reports/exportJobs
...
{
  "@odata.type": "#microsoft.graph.deviceManagementExportJob",
  "id": "9b5928d6-28d6-9b59-d628-599bd628599b",
  "reportName": "String",
  "filter": "String",
  "select": [
    "String"
