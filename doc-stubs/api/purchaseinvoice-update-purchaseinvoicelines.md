...
description: "Update the properties of a purchaseInvoiceLines object."
...
Update the properties of a purchaseInvoiceLines object.
...
-->
``` http
PATCH /financials/companies/{companyId}/purchaseInvoices/{purchaseInvoiceId}/purchaseInvoiceLines
```
...
<!-- {
  "blockType": "request",
  "name": "update_purchaseinvoicelines"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/purchaseInvoices/{purchaseInvoiceId}/purchaseInvoiceLines
