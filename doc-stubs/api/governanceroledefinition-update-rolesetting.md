---
title: "Update roleSetting"
description: "Update the properties of a roleSetting object."
...
Update the properties of a roleSetting object.
...
-->
``` http
PATCH ** Collection URI for microsoft.graph.governanceRoleSetting not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.graph.governanceRoleSetting not found
