...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicyId}/assignments
...
{
  "@odata.type": "#microsoft.graph.deviceCompliancePolicyAssignment",
  "id": "a1fa2038-2038-a1fa-3820-faa13820faa1",
  "target": {
    "@odata.type": "microsoft.graph.deviceAndAppManagementAssignmentTarget"
  }
}
