...
-->
``` http
PATCH /users/{usersId}/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/parentSectionGroup/parentSectionGroup
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/users/{usersId}/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/parentSectionGroup/parentSectionGroup
...
{
  "@odata.type": "#microsoft.graph.sectionGroup",
  "id": "f1bca257-a257-f1bc-57a2-bcf157a2bcf1",
  "self": "String",
