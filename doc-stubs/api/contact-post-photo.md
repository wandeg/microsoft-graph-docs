...
-->
``` http
POST /users/{usersId}/contacts/{contactId}/photo
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/users/{usersId}/contacts/{contactId}/photo
...
{
  "@odata.type": "#microsoft.graph.profilePhoto",
  "id": "4b4f9cab-9cab-4b4f-ab9c-4f4bab9c4f4b",
  "height": "Integer",
  "width": "Integer"
}
```
