---
title: "Update exactMatchUploadAgents"
description: "Update the properties of an exactMatchUploadAgents object."
...
# Update exactMatchUploadAgents

Namespace: microsoft.graph

Update the properties of an exactMatchUploadAgents object.
...
-->
``` http
PATCH /dataClassification/exactMatchUploadAgents
```
...
<!-- {
  "blockType": "request",
  "name": "update_exactmatchuploadagents"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/dataClassification/exactMatchUploadAgents
