...
-->
``` http
PATCH /deviceManagement/roleScopeTags/{roleScopeTagId}/assignments
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/roleScopeTags/{roleScopeTagId}/assignments
...
{
  "@odata.type": "#microsoft.graph.roleScopeTagAutoAssignment",
  "id": "610be444-e444-610b-44e4-0b6144e40b61",
  "target": {
    "@odata.type": "microsoft.graph.deviceAndAppManagementAssignmentTarget"
  }
}
