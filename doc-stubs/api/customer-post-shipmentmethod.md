...
-->
``` http
POST /financials/companies/{companyId}/customers/{customerId}/shipmentMethod
```
...
-->
``` http
POST https://graph.microsoft.com/beta/financials/companies/{companyId}/customers/{customerId}/shipmentMethod
