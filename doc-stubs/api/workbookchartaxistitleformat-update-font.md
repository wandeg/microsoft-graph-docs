...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/title/format/font
...
{
  "@odata.type": "#microsoft.graph.workbookChartFont",
  "id": "cc6d849b-849b-cc6d-9b84-6dcc9b846dcc",
  "bold": "Boolean",
  "color": "String",
  "italic": "Boolean",
  "name": "String",
