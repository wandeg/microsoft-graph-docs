...
-->
``` http
DELETE /organization/{organizationId}/branding/{organizationalBrandingId}/localizations/{organizationalBrandingLocalizationId}
```
...
-->
``` http
DELETE https://graph.microsoft.com/beta/organization/{organizationId}/branding/{organizationalBrandingId}/localizations/{organizationalBrandingLocalizationId}
```
