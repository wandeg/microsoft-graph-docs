...
-->
``` http
GET ** Collection URI for microsoft.graph.certificateBasedAuthConfiguration not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.certificateBasedAuthConfiguration not found
```
  ...
  "value": [
    {
      ...
      "id": "d22bab89-ab89-d22b-89ab-2bd289ab2bd2",
