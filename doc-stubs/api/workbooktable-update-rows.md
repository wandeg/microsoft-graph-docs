...
-->
``` http
PATCH https://graph.microsoft.com/beta/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/tables/{workbookTableId}/rows
...
{
  "@odata.type": "#microsoft.graph.workbookTableRow",
  "id": "6a3170ab-70ab-6a31-ab70-316aab70316a",
  "index": "Integer",
  "values": {
    "@odata.type": "microsoft.graph.Json"
  }
