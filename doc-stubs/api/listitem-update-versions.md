...
-->
``` http
PATCH /workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/versions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/workbooks/{workbooksId}/activities/{itemActivityOLDId}/listItem/versions
