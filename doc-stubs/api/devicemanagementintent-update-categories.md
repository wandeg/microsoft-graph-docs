...
-->
``` http
PATCH /deviceManagement/intents/{deviceManagementIntentId}/categories
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/intents/{deviceManagementIntentId}/categories
...
{
  "@odata.type": "#microsoft.graph.deviceManagementIntentSettingCategory",
  "id": "37c77a09-7a09-37c7-097a-c737097ac737",
  "displayName": "String",
  "hasRequiredSetting": "Boolean"
}
```
