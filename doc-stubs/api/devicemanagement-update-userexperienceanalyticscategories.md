...
description: "Update the properties of a userExperienceAnalyticsCategories object."
...
Update the properties of a userExperienceAnalyticsCategories object.
...
-->
``` http
PATCH /deviceManagement/userExperienceAnalyticsCategories
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/userExperienceAnalyticsCategories
