...
description: "Update the properties of a salesCreditMemoLines object."
...
Update the properties of a salesCreditMemoLines object.
...
-->
``` http
PATCH /financials/companies/{companyId}/salesCreditMemos/{salesCreditMemoId}/salesCreditMemoLines
```
...
<!-- {
  "blockType": "request",
  "name": "update_salescreditmemolines"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/salesCreditMemos/{salesCreditMemoId}/salesCreditMemoLines
