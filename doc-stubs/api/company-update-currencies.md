...
description: "Update the properties of a currencies object."
...
Update the properties of a currencies object.
...
-->
``` http
PATCH /financials/companies/{companyId}/currencies
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/currencies
