---
title: "Update managedDevices2"
description: "Update the properties of a managedDevices2 object."
...
# Update managedDevices2

Namespace: microsoft.graph

Update the properties of a managedDevices2 object.
...
-->
``` http
PATCH /users/{usersId}/managedDevices2
```
...
<!-- {
  "blockType": "request",
  "name": "update_manageddevices2"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/managedDevices2
