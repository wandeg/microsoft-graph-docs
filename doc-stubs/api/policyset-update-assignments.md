...
-->
``` http
PATCH /deviceAppManagement/policySets/{policySetId}/assignments
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceAppManagement/policySets/{policySetId}/assignments
...
{
  "@odata.type": "#microsoft.graph.policySetAssignment",
  "id": "2bcaf823-f823-2bca-23f8-ca2b23f8ca2b",
