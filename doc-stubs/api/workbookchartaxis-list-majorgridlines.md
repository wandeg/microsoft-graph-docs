...
-->
``` http
GET https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/majorGridlines
```
  ...
  "value": [
    {
      ...
      "id": "4b6f9049-9049-4b6f-4990-6f4b49906f4b",
      "visible": "Boolean"
    }
  ]
}
