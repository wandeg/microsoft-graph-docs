...
-->
``` http
GET https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/title
```
  ...
  "value": [
    {
      ...
      "id": "eaad7936-7936-eaad-3679-adea3679adea",
      "overlay": "Boolean",
      "text": "String",
      "visible": "Boolean"
    }
