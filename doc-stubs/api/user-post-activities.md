...
If successful, this method returns a `201 Created` response code and a [userActivity](../resources/projectrome-useractivity.md) object in the response body.
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/activities
