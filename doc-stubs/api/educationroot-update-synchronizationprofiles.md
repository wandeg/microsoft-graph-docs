---
title: "Update synchronizationProfiles"
description: "Update the properties of a synchronizationProfiles object."
...
# Update synchronizationProfiles

Namespace: microsoft.graph

Update the properties of a synchronizationProfiles object.
...
-->
``` http
PATCH /education/synchronizationProfiles
```
...
<!-- {
  "blockType": "request",
  "name": "update_synchronizationprofiles"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/education/synchronizationProfiles
