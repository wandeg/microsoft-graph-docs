...
-->
``` http
POST https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/seriesAxis
...
{
  "@odata.type": "#microsoft.graph.workbookChartAxis",
  "id": "cdbc5618-5618-cdbc-1856-bccd1856bccd",
  "majorUnit": {
    "@odata.type": "microsoft.graph.Json"
  },
  "maximum": {
