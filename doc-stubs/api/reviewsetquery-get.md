...
-->
``` http
GET /cases/{casesId}/reviewSets/{reviewSetId}/queries/{reviewSetQueryId}
```
...
-->
``` http
GET https://graph.microsoft.com/beta/cases/{casesId}/reviewSets/{reviewSetId}/queries/{reviewSetQueryId}
```
...
Content-Type: application/json
{
  "value": {
    ...
    "id": "c816c534-c534-c816-34c5-16c834c516c8",
    "displayName": "String",
