...
-->
``` http
PATCH /users/{usersId}/authentication/passwordMethods
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/authentication/passwordMethods
...
{
  "@odata.type": "#microsoft.graph.passwordAuthenticationMethod",
  "id": "f4153c4e-3c4e-f415-4e3c-15f44e3c15f4",
  "password": "String",
  "creationDateTime": "String (timestamp)"
}
```
