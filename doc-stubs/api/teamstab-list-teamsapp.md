...
-->
``` http
GET /teams/{teamsId}/channels/{channelId}/tabs/{teamsTabId}/teamsApp
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/teams/{teamsId}/channels/{channelId}/tabs/{teamsTabId}/teamsApp
```
