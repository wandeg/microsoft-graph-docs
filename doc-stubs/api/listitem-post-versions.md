...
-->
``` http
POST /workbooks/{workbooksId}/listItem/versions
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/listItem/versions
...
{
  "@odata.type": "#microsoft.graph.listItemVersion",
  "id": "6d0ff35d-f35d-6d0f-5df3-0f6d5df30f6d",
  "lastModifiedBy": {
