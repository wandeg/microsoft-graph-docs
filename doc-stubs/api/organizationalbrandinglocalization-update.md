...
-->
``` http
PATCH /organization/{organizationId}/branding/{organizationalBrandingId}/localizations/{organizationalBrandingLocalizationId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/organization/{organizationId}/branding/{organizationalBrandingId}/localizations/{organizationalBrandingLocalizationId}
