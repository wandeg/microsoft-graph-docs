...
description: "Update the properties of a paymentTerms object."
...
-->
``` http
PATCH /financials/companies/{companyId}/paymentTerms
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/paymentTerms
