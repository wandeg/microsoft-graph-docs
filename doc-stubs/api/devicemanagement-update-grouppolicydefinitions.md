---
title: "Update groupPolicyDefinitions"
description: "Update the properties of a groupPolicyDefinitions object."
...
# Update groupPolicyDefinitions

Namespace: microsoft.graph

Update the properties of a groupPolicyDefinitions object.
...
-->
``` http
PATCH /deviceManagement/groupPolicyDefinitions
```
...
<!-- {
  "blockType": "request",
  "name": "update_grouppolicydefinitions"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/deviceManagement/groupPolicyDefinitions
