...
-->
``` http
POST /teams/{teamsId}/channels/{channelId}/tabs/{teamsTabId}/teamsApp/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/teams/{teamsId}/channels/{channelId}/tabs/{teamsTabId}/teamsApp/$ref
