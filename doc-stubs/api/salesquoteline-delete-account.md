...
<!-- {
  "blockType": "request",
  "name": "delete_account_from_salesquoteline"
}
-->
``` http
DELETE https://graph.microsoft.com/beta/financials/companies/{companyId}/salesQuotes/{salesQuoteId}/salesQuoteLines/{salesQuoteLineId}/account
```
