...
-->
``` http
PATCH /informationProtection/threatAssessmentRequests
```
...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/informationProtection/threatAssessmentRequests
...
{
  "@odata.type": "#microsoft.graph.threatAssessmentRequest",
  "id": "f62ee2ca-e2ca-f62e-cae2-2ef6cae22ef6",
