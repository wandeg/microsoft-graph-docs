...
-->
``` http
PATCH /users/{usersId}/informationProtection/threatAssessmentRequests
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/informationProtection/threatAssessmentRequests
