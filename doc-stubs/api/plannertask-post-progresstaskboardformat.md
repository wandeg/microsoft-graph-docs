...
-->
``` http
POST /users/{usersId}/planner/tasks/{plannerTaskId}/progressTaskBoardFormat
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/planner/tasks/{plannerTaskId}/progressTaskBoardFormat
