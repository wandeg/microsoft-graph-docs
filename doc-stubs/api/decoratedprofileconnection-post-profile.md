...
-->
``` http
POST /decoratedProfileConnections/{decoratedProfileConnectionsId}/profile
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/decoratedProfileConnections/{decoratedProfileConnectionsId}/profile
