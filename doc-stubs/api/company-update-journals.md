...
description: "Update the properties of a journals object."
...
Update the properties of a journals object.
...
-->
``` http
PATCH /financials/companies/{companyId}/journals
```
...
<!-- {
  "blockType": "request",
  "name": "update_journals"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/journals
