...
-->
``` http
GET https://graph.microsoft.com/beta/print/reports/getPrintUsageSummariesByTimeSpan(periodStart=String (timestamp),periodEnd=String (timestamp),timeSpanInMinutes=Integer)
```
