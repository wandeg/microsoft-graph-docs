...
-->
``` http
PATCH https://graph.microsoft.com/v1.0/workbooks/{workbooksId}/workbook/names/{workbookNamedItemId}/worksheet/charts/{workbookChartId}/axes/categoryAxis/title
...
{
  "@odata.type": "#microsoft.graph.workbookChartAxisTitle",
  "id": "dce3083c-083c-dce3-3c08-e3dc3c08e3dc",
  "text": "String",
  "visible": "Boolean"
}
```
