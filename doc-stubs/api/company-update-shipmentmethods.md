...
description: "Update the properties of a shipmentMethods object."
...
-->
``` http
PATCH /financials/companies/{companyId}/shipmentMethods
```
...
<!-- {
  "blockType": "request",
  "name": "update_shipmentmethods"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/shipmentMethods
