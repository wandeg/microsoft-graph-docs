---
title: "Create managedDevices2"
description: "Create a new managedDevices2 object."
...
# Create managedDevices2

Namespace: microsoft.graph

Create a new managedDevices2 object.
...
-->
``` http
POST /users/{usersId}/managedDevices2
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/managedDevices2
