...
-->
``` http
POST ** Collection URI for microsoft.graph.oAuth2PermissionGrant not found/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.oAuth2PermissionGrant not found/$ref
...
{
  "@odata.type": "#microsoft.graph.oAuth2PermissionGrant",
  "id": "cba8e6ee-e6ee-cba8-eee6-a8cbeee6a8cb",
  "clientId": "String",
  "consentType": "String",
  "expiryTime": "String (timestamp)",
  "principalId": "String",
