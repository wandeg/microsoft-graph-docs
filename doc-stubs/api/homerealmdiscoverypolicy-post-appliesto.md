...
-->
``` http
POST /policyRoot/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicyId}/appliesTo/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/policyRoot/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicyId}/appliesTo/$ref
...
{
  "@odata.type": "#Microsoft.DirectoryServices.directoryObject",
  "id": "87dc3523-3523-87dc-2335-dc872335dc87",
  "deletedDateTime": "String (timestamp)"
}
```
