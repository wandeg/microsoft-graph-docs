...
-->
``` http
PATCH /users/{usersId}/informationProtection/dataLossPreventionPolicies
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/informationProtection/dataLossPreventionPolicies
