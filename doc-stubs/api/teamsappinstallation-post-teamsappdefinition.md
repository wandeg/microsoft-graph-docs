...
-->
``` http
POST /teams/{teamsId}/installedApps/{teamsAppInstallationId}/teamsAppDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/teams/{teamsId}/installedApps/{teamsAppInstallationId}/teamsAppDefinition/$ref
...
{
  "@odata.type": "#microsoft.graph.teamsAppDefinition",
  "id": "29423838-3838-2942-3838-422938384229",
  "teamsAppId": "String",
  "displayName": "String",
  "version": "String"
}
