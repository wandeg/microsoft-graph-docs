...
-->
``` http
POST /users/{usersId}/teamwork/installedApps/{teamsAppInstallationId}/teamsAppDefinition/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/teamwork/installedApps/{teamsAppInstallationId}/teamsAppDefinition/$ref
