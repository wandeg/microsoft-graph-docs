...
-->
``` http
POST /financials/companies/{companyId}/vendors/{vendorId}/paymentTerm
```
...
-->
``` http
POST https://graph.microsoft.com/beta/financials/companies/{companyId}/vendors/{vendorId}/paymentTerm
