...
POST /users/{usersId}/onenote/notebooks/{notebookId}/sections/{onenoteSectionId}/pages/{onenotePageId}/copyToSection
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/me/onenote/pages/{onenotePageId}/copyToSection
