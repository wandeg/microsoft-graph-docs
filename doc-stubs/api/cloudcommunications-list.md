---
title: "List cloudCommunications"
description: "Get a list of the cloudCommunications objects and their properties."
...
# List cloudCommunications
Namespace: microsoft.graph

Get a list of the [cloudCommunications](../resources/cloudcommunications.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.cloudCommunications not found
```
