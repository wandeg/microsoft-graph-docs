...
description: "Update the properties of a taxAreas object."
...
Update the properties of a taxAreas object.
...
-->
``` http
PATCH /financials/companies/{companyId}/taxAreas
```
...
<!-- {
  "blockType": "request",
  "name": "update_taxareas"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/financials/companies/{companyId}/taxAreas
...
{
  "@odata.type": "#microsoft.graph.taxArea",
  "id": "7ce3dc3a-dc3a-7ce3-3adc-e37c3adce37c",
  "code": "String",
  "displayName": "String",
  "taxType": "String",
