...
-->
``` http
POST /users/{usersId}/teamwork/installedApps/{teamsAppInstallationId}/teamsApp/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/teamwork/installedApps/{teamsAppInstallationId}/teamsApp/$ref
