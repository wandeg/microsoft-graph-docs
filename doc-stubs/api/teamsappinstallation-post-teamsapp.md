...
-->
``` http
POST /teams/{teamsId}/installedApps/{teamsAppInstallationId}/teamsApp/$ref
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0/teams/{teamsId}/installedApps/{teamsAppInstallationId}/teamsApp/$ref
...
{
  "@odata.type": "#microsoft.graph.teamsApp",
  "id": "dd0e5110-5110-dd0e-1051-0edd10510edd",
  "externalId": "String",
  "displayName": "String",
  "distributionMethod": "String"
}
