...
description: "Update the properties of a labelsAndPoliciesEvaluationJobs object."
...
Update the properties of a labelsAndPoliciesEvaluationJobs object.
...
-->
``` http
PATCH /dataClassification/labelsAndPoliciesEvaluationJobs
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/dataClassification/labelsAndPoliciesEvaluationJobs
