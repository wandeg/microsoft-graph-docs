...
-->
``` http
POST /organization/{organizationId}/branding/{organizationalBrandingId}/localizations
```
...
-->
``` http
POST https://graph.microsoft.com/beta/organization/{organizationId}/branding/{organizationalBrandingId}/localizations
