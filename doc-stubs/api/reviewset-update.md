...
-->
``` http
PATCH /cases/{casesId}/reviewSets/{reviewSetId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/cases/{casesId}/reviewSets/{reviewSetId}
...
{
  "@odata.type": "#microsoft.graph.reviewSet",
  "id": "76089a1b-9a1b-7608-1b9a-08761b9a0876",
  "createdBy": "String",
  "displayName": "String",
