...
|:---|:---|:---|
|groupIdSourceOption|deliveryOptimizationGroupIdOptionsType|**TODO: Add Description**. Possible values are: `notConfigured`, `adSite`, `authenticatedDomainSid`, `dhcpUserOption`, `dnsSuffix`.|
